...
#ifndef META_SPECIFICATION_COPY_CHILD_LINKS_H
#  define META_SPECIFICATION_COPY_CHILD_LINKS_H
...
#     define META_SPECIFICATION_COPY_CHILD_LINKS_DECL_SPEC DYNAMIC_EXPORT
#  else
#     define META_SPECIFICATION_COPY_CHILD_LINKS_DECL_SPEC DYNAMIC_IMPORT
#  endif
...
class META_SPECIFICATION_COPY_CHILD_LINKS_DECL_SPEC Meta_Specification_Copy_Child_Links : public Meta_Specification
{
   ...
   public:
   typedef Meta_Specification_Copy_Child_Links class_type;
   typedef Meta_Specification parent_class_type;

   enum field_id
   {
      e_field_id_none = 0,
      e_field_id_Child_File_Field = 1,
      e_field_id_Source_Child_File_Field = 2,
      e_field_id_Source_Child_Rel_Child_Class = 3,
      e_field_id_Source_Child_Relationship = 4
   };

   Meta_Specification_Copy_Child_Links( );
   ~Meta_Specification_Copy_Child_Links( );

   Meta_Field& Child_File_Field( );
   const Meta_Field& Child_File_Field( ) const;
   void Child_File_Field( const std::string& key );

   Meta_Field& Source_Child_File_Field( );
   const Meta_Field& Source_Child_File_Field( ) const;
   void Source_Child_File_Field( const std::string& key );

   Meta_Class& Source_Child_Rel_Child_Class( );
   const Meta_Class& Source_Child_Rel_Child_Class( ) const;
   void Source_Child_Rel_Child_Class( const std::string& key );

   Meta_Relationship& Source_Child_Relationship( );
   const Meta_Relationship& Source_Child_Relationship( ) const;
   void Source_Child_Relationship( const std::string& key );
   ...
   static const char* static_class_id( ) { return "132100"; }
   static const char* static_class_name( ) { return "Specification_Copy_Child_Links"; }
   static const char* static_plural_name( ) { return "Specification_Copy_Child_Links"; }
   ...
   static void static_insert_external_alias( const std::string& module_and_class_id, Meta_Specification_Copy_Child_Links* p_instance );
   static void static_remove_external_alias( const std::string& module_and_class_id );

   private:
   Meta_Specification_Copy_Child_Links( const Meta_Specification_Copy_Child_Links& );
   Meta_Specification_Copy_Child_Links& operator =( const Meta_Specification_Copy_Child_Links& );
...
inline std::string to_string( const Meta_Specification_Copy_Child_Links& c ) { return c.get_key( ); }

inline bool is_null( const Meta_Specification_Copy_Child_Links& c ) { return c.get_key( ).empty( ); }

inline bool check_equal( const Meta_Specification_Copy_Child_Links& c, const char* p ) { return c.get_key( ) == p; }
inline bool check_not_equal( const Meta_Specification_Copy_Child_Links& c, const char* p ) { return !( c.get_key( ) == p ); }
