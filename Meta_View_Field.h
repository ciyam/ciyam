...
class META_VIEW_FIELD_DECL_SPEC Meta_View_Field : public class_base
{
   ...
   enum field_id
   {
      ...
      e_field_id_Child_List_Extra_Option = 8,
      e_field_id_Class = 9,
      e_field_id_Date_Precision_Option = 10,
      e_field_id_Enum_Finishes_At = 11,
      e_field_id_Enum_Starts_At = 12,
      e_field_id_FK_Trigger_Behaviour = 13,
      e_field_id_FK_Trigger_Option = 14,
      e_field_id_Font_Size = 15,
      e_field_id_Ignore_Manual_Links = 16,
      e_field_id_Label_Without_Prefix = 17,
      e_field_id_Link_Permission = 18,
      e_field_id_Link_Restriction = 19,
      e_field_id_Mandatory_Option = 20,
      e_field_id_Name = 21,
      e_field_id_New_Source = 22,
      e_field_id_New_Value = 23,
      e_field_id_Order = 24,
      e_field_id_Restriction_Spec = 25,
      e_field_id_Show_Hide_Start_Point = 26,
      e_field_id_Sort_Manually = 27,
      e_field_id_Source_Child = 28,
      e_field_id_Source_Edit_Child = 29,
      e_field_id_Source_Field = 30,
      e_field_id_Source_Parent = 31,
      e_field_id_Source_Parent_Class = 32,
      e_field_id_Tab_Name = 33,
      e_field_id_Trigger_Behaviour = 34,
