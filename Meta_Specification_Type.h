...
class META_SPECIFICATION_TYPE_DECL_SPEC Meta_Specification_Type : public class_base
{
   ...
   enum field_id
   {
      ...
      e_field_id_Needs_Other_Modifier = 48,
      e_field_id_Needs_Other_Modifier_2 = 49,
      e_field_id_Needs_Other_Permission = 50,
      e_field_id_Needs_Other_Permission_2 = 51,
      e_field_id_Needs_Other_Procedure = 52,
      e_field_id_Needs_Other_Procedure_2 = 53,
      e_field_id_Needs_Permission = 54,
      e_field_id_Needs_Procedure = 55,
      e_field_id_Needs_Procedure_Arg = 56,
      e_field_id_Needs_Procedure_Arg_2 = 57,
      e_field_id_Needs_Procedure_Arg_3 = 58,
      e_field_id_Needs_Source_Child = 59,
      e_field_id_Needs_Source_Child_2 = 60,
      e_field_id_Needs_Source_Field = 61,
      e_field_id_Needs_Source_Field_Or_Child = 62,
      e_field_id_Needs_Source_Parent = 63,
      e_field_id_Needs_Test_Field = 64,
      e_field_id_Needs_Test_Value = 65,
      e_field_id_Needs_Value = 66,
      e_field_id_Next_Child_Specification_Type = 67,
      e_field_id_Next_Protect_Child_Rel = 68,
      e_field_id_Next_Protect_Procedure = 69,
      e_field_id_Next_Protect_Source_Parent = 70,
      e_field_id_Next_Specification_Actions = 71,
      e_field_id_Notes = 72,
      e_field_id_Parent_Specification_Type = 73,
      e_field_id_Procedure_Arg_primitive = 74,
      e_field_id_Procedure_Arg_type = 75,
      e_field_id_Protect_Child_Rel_From_Update = 76,
      e_field_id_Protect_Class_From_Edit = 77,
      e_field_id_Protect_Class_From_Update = 78,
      e_field_id_Protect_Procedure_From_Edit = 79,
      e_field_id_Protect_Source_Parent = 80,
      e_field_id_Set_Field_To_Source_Field_Or_Child = 81,
      e_field_id_Source_Field_Needs_Test_Field = 82,
      e_field_id_Source_Field_Type_Match = 83,
      e_field_id_Source_Parent_type = 84,
      e_field_id_Source_type = 85,
      e_field_id_Specification_Actions = 86,
      e_field_id_Specification_Name = 87,
      e_field_id_Specification_Object = 88,
      e_field_id_Specification_Strings = 89,
      e_field_id_Specification_Vars = 90,
      e_field_id_Test_Field_Type_Match = 91,
      e_field_id_Test_Field_type = 92,
      e_field_id_Use_Class_As_Source_Parent_Class = 93,
      e_field_id_Use_Field_Enum = 94,
      e_field_id_Use_Parent_Child_Rel_As_Source_Parent = 95,
      e_field_id_Use_Parent_Child_Rel_For_Class = 96,
      e_field_id_Use_Parent_Class = 97,
      e_field_id_Use_Parent_Field_For_Class = 98,
      e_field_id_Use_Parent_Other_Class_For_Class = 99,
      e_field_id_Use_Parent_Procedure = 100,
      e_field_id_Use_Parent_Source_Class = 101,
      e_field_id_Use_Parent_Source_Field_For_Class = 102,
      e_field_id_Use_Parent_Source_Parent = 103,
      e_field_id_Use_Parent_Source_Parent_For_Class = 104,
      e_field_id_View_Id = 105
   };
