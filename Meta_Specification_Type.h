...
class META_SPECIFICATION_TYPE_DECL_SPEC Meta_Specification_Type : public class_base
{
   ...
   enum field_id
   {
      ...
      e_field_id_Needs_Other_Permission = 48,
      e_field_id_Needs_Other_Permission_2 = 49,
      e_field_id_Needs_Other_Procedure = 50,
      e_field_id_Needs_Other_Procedure_2 = 51,
      e_field_id_Needs_Permission = 52,
      e_field_id_Needs_Procedure = 53,
      e_field_id_Needs_Procedure_Arg = 54,
      e_field_id_Needs_Procedure_Arg_2 = 55,
      e_field_id_Needs_Procedure_Arg_3 = 56,
      e_field_id_Needs_Source_Child = 57,
      e_field_id_Needs_Source_Child_2 = 58,
      e_field_id_Needs_Source_Field = 59,
      e_field_id_Needs_Source_Field_Or_Child = 60,
      e_field_id_Needs_Source_Parent = 61,
      e_field_id_Needs_Test_Field = 62,
      e_field_id_Needs_Test_Value = 63,
      e_field_id_Needs_Value = 64,
      e_field_id_Next_Child_Specification_Type = 65,
      e_field_id_Next_Protect_Child_Rel = 66,
      e_field_id_Next_Protect_Procedure = 67,
      e_field_id_Next_Protect_Source_Parent = 68,
      e_field_id_Next_Specification_Actions = 69,
      e_field_id_Notes = 70,
      e_field_id_Parent_Specification_Type = 71,
      e_field_id_Procedure_Arg_primitive = 72,
      e_field_id_Procedure_Arg_type = 73,
      e_field_id_Protect_Child_Rel_From_Update = 74,
      e_field_id_Protect_Class_From_Edit = 75,
      e_field_id_Protect_Class_From_Update = 76,
      e_field_id_Protect_Procedure_From_Edit = 77,
      e_field_id_Protect_Source_Parent = 78,
      e_field_id_Set_Field_To_Source_Field_Or_Child = 79,
      e_field_id_Source_Field_Needs_Test_Field = 80,
      e_field_id_Source_Field_Type_Match = 81,
      e_field_id_Source_Parent_type = 82,
      e_field_id_Source_type = 83,
      e_field_id_Specification_Actions = 84,
      e_field_id_Specification_Name = 85,
      e_field_id_Specification_Object = 86,
      e_field_id_Specification_Strings = 87,
      e_field_id_Specification_Vars = 88,
      e_field_id_Test_Field_Type_Match = 89,
      e_field_id_Test_Field_type = 90,
      e_field_id_Use_Class_As_Source_Parent_Class = 91,
      e_field_id_Use_Field_Enum = 92,
      e_field_id_Use_Parent_Child_Rel_As_Source_Parent = 93,
      e_field_id_Use_Parent_Child_Rel_For_Class = 94,
      e_field_id_Use_Parent_Class = 95,
      e_field_id_Use_Parent_Field_For_Class = 96,
      e_field_id_Use_Parent_Other_Class_For_Class = 97,
      e_field_id_Use_Parent_Procedure = 98,
      e_field_id_Use_Parent_Source_Class = 99,
      e_field_id_Use_Parent_Source_Field_For_Class = 100,
      e_field_id_Use_Parent_Source_Parent = 101,
      e_field_id_Use_Parent_Source_Parent_For_Class = 102,
      e_field_id_View_Id = 103
   };
