...
class META_SPECIFICATION_TYPE_DECL_SPEC Meta_Specification_Type : public class_base
{
   ...
   enum field_id
   {
      ...
      e_field_id_Allow_FK_Source_Field_Choice = 2,
      e_field_id_Allow_FK_Test_Field_Choice = 3,
      e_field_id_Allow_Field = 4,
      e_field_id_Allow_Modifier = 5,
      e_field_id_Allow_Options = 6,
      e_field_id_Allow_Other_Class = 7,
      e_field_id_Allow_Other_Field = 8,
      e_field_id_Allow_Other_Field_2 = 9,
      e_field_id_Allow_Permission = 10,
      e_field_id_Allow_Procedure = 11,
      e_field_id_Allow_Source_Child = 12,
      e_field_id_Allow_Source_Child_2 = 13,
      e_field_id_Allow_Source_Class = 14,
      e_field_id_Allow_Source_Field = 15,
      e_field_id_Allow_Source_Grandchild = 16,
      e_field_id_Allow_Source_Parent = 17,
      e_field_id_Allow_Test_Field = 18,
      e_field_id_Allow_Test_Value = 19,
      e_field_id_Allow_Value = 20,
      e_field_id_Child_Prefix = 21,
      e_field_id_Child_Rel_Grandparent_Match = 22,
      e_field_id_Child_Rel_Parent_Match = 23,
      e_field_id_Child_Relationship_Class_Match = 24,
      e_field_id_Child_Specification_Type = 25,
      e_field_id_Default_Child_Vars = 26,
      e_field_id_Field_type = 27,
      e_field_id_Has_Next_Specification_Info = 28,
      e_field_id_Is_Child_Only = 29,
      e_field_id_Is_Required_For_UI_Gen = 30,
      e_field_id_Is_System = 31,
      e_field_id_Name = 32,
      e_field_id_Needs_Child_Relationship = 33,
      e_field_id_Needs_Class = 34,
      e_field_id_Needs_Enum = 35,
      e_field_id_Needs_Enum_Item = 36,
      e_field_id_Needs_Enum_Item_2 = 37,
      e_field_id_Needs_Enum_Item_3 = 38,
      e_field_id_Needs_Enum_Item_4 = 39,
      e_field_id_Needs_Enum_Item_5 = 40,
      e_field_id_Needs_Field = 41,
      e_field_id_Needs_Modifier = 42,
      e_field_id_Needs_Other_Class = 43,
      e_field_id_Needs_Other_Field = 44,
      e_field_id_Needs_Other_Field_2 = 45,
      e_field_id_Needs_Other_Procedure = 46,
      e_field_id_Needs_Other_Procedure_2 = 47,
      e_field_id_Needs_Permission = 48,
      e_field_id_Needs_Procedure = 49,
      e_field_id_Needs_Procedure_Arg = 50,
      e_field_id_Needs_Procedure_Arg_2 = 51,
      e_field_id_Needs_Procedure_Arg_3 = 52,
      e_field_id_Needs_Source_Child = 53,
      e_field_id_Needs_Source_Child_2 = 54,
      e_field_id_Needs_Source_Field = 55,
      e_field_id_Needs_Source_Field_Or_Child = 56,
      e_field_id_Needs_Source_Parent = 57,
      e_field_id_Needs_Test_Field = 58,
      e_field_id_Needs_Test_Value = 59,
      e_field_id_Needs_Value = 60,
      e_field_id_Next_Child_Specification_Type = 61,
      e_field_id_Next_Protect_Child_Rel = 62,
      e_field_id_Next_Protect_Procedure = 63,
      e_field_id_Next_Protect_Source_Parent = 64,
      e_field_id_Next_Specification_Actions = 65,
      e_field_id_Notes = 66,
      e_field_id_Parent_Specification_Type = 67,
      e_field_id_Procedure_Arg_primitive = 68,
      e_field_id_Procedure_Arg_type = 69,
      e_field_id_Protect_Child_Rel_From_Update = 70,
      e_field_id_Protect_Class_From_Edit = 71,
      e_field_id_Protect_Class_From_Update = 72,
      e_field_id_Protect_Procedure_From_Edit = 73,
      e_field_id_Protect_Source_Parent = 74,
      e_field_id_Set_Field_To_Source_Field_Or_Child = 75,
      e_field_id_Source_Field_Needs_Test_Field = 76,
      e_field_id_Source_Field_Type_Match = 77,
      e_field_id_Source_Parent_type = 78,
      e_field_id_Source_type = 79,
      e_field_id_Specification_Actions = 80,
      e_field_id_Specification_Name = 81,
      e_field_id_Specification_Object = 82,
      e_field_id_Specification_Strings = 83,
      e_field_id_Specification_Vars = 84,
      e_field_id_Test_Field_Type_Match = 85,
      e_field_id_Test_Field_type = 86,
      e_field_id_Use_Class_As_Source_Parent_Class = 87,
      e_field_id_Use_Field_Enum = 88,
      e_field_id_Use_Parent_Child_Rel_As_Source_Parent = 89,
      e_field_id_Use_Parent_Child_Rel_For_Class = 90,
      e_field_id_Use_Parent_Class = 91,
      e_field_id_Use_Parent_Field_For_Class = 92,
      e_field_id_Use_Parent_Other_Class_For_Class = 93,
      e_field_id_Use_Parent_Procedure = 94,
      e_field_id_Use_Parent_Source_Class = 95,
      e_field_id_Use_Parent_Source_Field_For_Class = 96,
      e_field_id_Use_Parent_Source_Parent = 97,
      e_field_id_Use_Parent_Source_Parent_For_Class = 98,
      e_field_id_View_Id = 99
   };
