...
class META_SPECIFICATION_TYPE_DECL_SPEC Meta_Specification_Type : public class_base
{
   ...
   enum field_id
   {
      ...
      e_field_id_Allow_Options = 5,
      e_field_id_Allow_Other_Class = 6,
      e_field_id_Allow_Other_Field = 7,
      e_field_id_Allow_Other_Field_2 = 8,
      e_field_id_Allow_Permission = 9,
      e_field_id_Allow_Procedure = 10,
      e_field_id_Allow_Source_Child = 11,
      e_field_id_Allow_Source_Child_2 = 12,
      e_field_id_Allow_Source_Class = 13,
      e_field_id_Allow_Source_Field = 14,
      e_field_id_Allow_Source_Grandchild = 15,
      e_field_id_Allow_Source_Parent = 16,
      e_field_id_Allow_Test_Field = 17,
      e_field_id_Allow_Test_Value = 18,
      e_field_id_Allow_Value = 19,
      e_field_id_Child_Prefix = 20,
      e_field_id_Child_Rel_Grandparent_Match = 21,
      e_field_id_Child_Rel_Parent_Match = 22,
      e_field_id_Child_Relationship_Class_Match = 23,
      e_field_id_Child_Specification_Type = 24,
      e_field_id_Default_Child_Vars = 25,
      e_field_id_Field_type = 26,
      e_field_id_Has_Next_Specification_Info = 27,
      e_field_id_Is_Child_Only = 28,
      e_field_id_Is_Required_For_UI_Gen = 29,
      e_field_id_Is_System = 30,
      e_field_id_Name = 31,
      e_field_id_Needs_Child_Relationship = 32,
      e_field_id_Needs_Class = 33,
      e_field_id_Needs_Enum = 34,
      e_field_id_Needs_Enum_Item = 35,
      e_field_id_Needs_Enum_Item_2 = 36,
      e_field_id_Needs_Enum_Item_3 = 37,
      e_field_id_Needs_Enum_Item_4 = 38,
      e_field_id_Needs_Enum_Item_5 = 39,
      e_field_id_Needs_Field = 40,
      e_field_id_Needs_Modifier = 41,
      e_field_id_Needs_Other_Class = 42,
      e_field_id_Needs_Other_Field = 43,
      e_field_id_Needs_Other_Field_2 = 44,
      e_field_id_Needs_Other_Procedure = 45,
      e_field_id_Needs_Other_Procedure_2 = 46,
      e_field_id_Needs_Permission = 47,
      e_field_id_Needs_Procedure = 48,
      e_field_id_Needs_Procedure_Arg = 49,
      e_field_id_Needs_Procedure_Arg_2 = 50,
      e_field_id_Needs_Procedure_Arg_3 = 51,
      e_field_id_Needs_Source_Child = 52,
      e_field_id_Needs_Source_Child_2 = 53,
      e_field_id_Needs_Source_Field = 54,
      e_field_id_Needs_Source_Field_Or_Child = 55,
      e_field_id_Needs_Source_Parent = 56,
      e_field_id_Needs_Test_Field = 57,
      e_field_id_Needs_Test_Value = 58,
      e_field_id_Needs_Value = 59,
      e_field_id_Next_Child_Specification_Type = 60,
      e_field_id_Next_Protect_Child_Rel = 61,
      e_field_id_Next_Protect_Procedure = 62,
      e_field_id_Next_Protect_Source_Parent = 63,
      e_field_id_Next_Specification_Actions = 64,
      e_field_id_Notes = 65,
      e_field_id_Parent_Specification_Type = 66,
      e_field_id_Procedure_Arg_primitive = 67,
      e_field_id_Procedure_Arg_type = 68,
      e_field_id_Protect_Child_Rel_From_Update = 69,
      e_field_id_Protect_Class_From_Edit = 70,
      e_field_id_Protect_Class_From_Update = 71,
      e_field_id_Protect_Procedure_From_Edit = 72,
      e_field_id_Protect_Source_Parent = 73,
      e_field_id_Set_Field_To_Source_Field_Or_Child = 74,
      e_field_id_Source_Field_Needs_Test_Field = 75,
      e_field_id_Source_Field_Type_Match = 76,
      e_field_id_Source_Parent_type = 77,
      e_field_id_Source_type = 78,
      e_field_id_Specification_Actions = 79,
      e_field_id_Specification_Name = 80,
      e_field_id_Specification_Object = 81,
      e_field_id_Specification_Strings = 82,
      e_field_id_Specification_Vars = 83,
      e_field_id_Test_Field_Type_Match = 84,
      e_field_id_Test_Field_type = 85,
      e_field_id_Use_Class_As_Source_Parent_Class = 86,
      e_field_id_Use_Field_Enum = 87,
      e_field_id_Use_Parent_Child_Rel_As_Source_Parent = 88,
      e_field_id_Use_Parent_Child_Rel_For_Class = 89,
      e_field_id_Use_Parent_Class = 90,
      e_field_id_Use_Parent_Field_For_Class = 91,
      e_field_id_Use_Parent_Other_Class_For_Class = 92,
      e_field_id_Use_Parent_Procedure = 93,
      e_field_id_Use_Parent_Source_Class = 94,
      e_field_id_Use_Parent_Source_Field_For_Class = 95,
      e_field_id_Use_Parent_Source_Parent = 96,
      e_field_id_Use_Parent_Source_Parent_For_Class = 97,
      e_field_id_View_Id = 98
   };
