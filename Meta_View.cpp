...
void Meta_View_command_functor::operator ( )( const string& command, const parameter_info& parameters )
{
   ...
   else if( command == c_cmd_Meta_View_get )
   {
      ...
      else if( field_name == c_field_id_Allow_Copy_Action || field_name == c_field_name_Allow_Copy_Action )
      ...
      else if( field_name == c_field_id_PDF_View_Type || field_name == c_field_name_PDF_View_Type )
...
void Meta_View::impl::validate( unsigned state, bool is_internal, validation_error_container* p_validation_errors )
{
   ...
   if( is_null( v_Type_Key ) && !value_will_be_provided( c_field_name_Type_Key ) )
      p_validation_errors->insert( validation_error_value_type( c_field_name_Type_Key,
       get_string_message( GS( c_str_field_must_not_be_empty ), make_pair(
   ...
   if( !g_view_pdf_view_type_enum.count( v_PDF_View_Type ) )
      p_validation_errors->insert( validation_error_value_type( c_field_name_PDF_View_Type,
       get_string_message( GS( c_str_field_has_invalid_value ), make_pair(
...
bool Meta_View::impl::is_filtered( const set< string >& filters ) const
{
   ( void )filters;
...
bool Meta_View::is_filtered( const set< string >& filters ) const
{
...
const char* Meta_View::class_name( ) const
{
   return static_class_name( );
}

const char* Meta_View::plural_name( ) const
{
   return static_plural_name( );
}

const char* Meta_View::module_id( ) const
{
   return static_module_id( );
}

const char* Meta_View::module_name( ) const
{
