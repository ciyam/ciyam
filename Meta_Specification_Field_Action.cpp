...
const uint64_t c_modifier_Hide_Record_Create_Info = UINT64_C( 0x1000000000000 );
...
void Meta_Specification_Field_Action_command_functor::operator ( )( const string& command, const parameter_info& parameters )
{
   ...
   {
      bool want_fixed( has_parm_val( parameters, c_cmd_parm_Meta_Specification_Field_Action_key_fixed ) );
   ...
   {
      string field_name( get_parm_val( parameters, c_cmd_parm_Meta_Specification_Field_Action_cmd_field_name ) );
      string cmd_and_args( get_parm_val( parameters, c_cmd_parm_Meta_Specification_Field_Action_cmd_cmd_and_args ) );
   ...
   {
      string Parent_Prefix( get_parm_val_from_string< string >( parameters, c_cmd_parm_Meta_Specification_Field_Action_Generate_All_Vars_Parent_Prefix ) );
      string All_Vars;
...
void Meta_Specification_Field_Action::impl::validate( unsigned state, bool is_internal, validation_error_container* p_validation_errors )
{
   ( void )state;
   ( void )is_internal;
...
void Meta_Specification_Field_Action::validate( unsigned state, bool is_internal )
{
...
void Meta_Specification_Field_Action::finalise_fetch( )
{
