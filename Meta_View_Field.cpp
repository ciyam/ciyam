...
int gv_default_Link_Restriction = int( 2 );
...
const int c_enum_view_field_link_restrict_admin_only( 1 );
const int c_enum_view_field_link_restrict_denied_always( 2 );
...
string Meta_View_Field::get_field_display_name( const string& id ) const
{
   string display_name;
...
string Meta_View_Field::static_get_sql_columns( )
{
   ...
   sql_columns += 
    ...
    "C_New_Value VARCHAR(128) NOT NULL,"
    ...
    "C_Tab_Name VARCHAR(128) NOT NULL,"
