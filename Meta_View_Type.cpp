...
bool Meta_View_Type::impl::is_filtered( const set< string >& filters ) const
{
   ( void )filters;
...
bool Meta_View_Type::is_filtered( const set< string >& filters ) const
{
...
string Meta_View_Type::get_field_display_name( const string& id ) const
{
   string display_name;
