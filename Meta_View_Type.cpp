...
void Meta_View_Type_command_functor::operator ( )( const string& command, const parameter_info& parameters )
{
   ...
   {
      bool want_fixed( has_parm_val( parameters, c_cmd_parm_Meta_View_Type_key_fixed ) );
   ...
   {
      string field_name( get_parm_val( parameters, c_cmd_parm_Meta_View_Type_cmd_field_name ) );
      string cmd_and_args( get_parm_val( parameters, c_cmd_parm_Meta_View_Type_cmd_cmd_and_args ) );
...
struct Meta_View_Type::impl : public Meta_View_Type_command_handler
{
   ...
   void impl_View_Name( const string& View_Name ) { v_View_Name = View_Name; }
...
void Meta_View_Type::impl::validate( unsigned state, bool is_internal, validation_error_container* p_validation_errors )
{
   ( void )state;
   ( void )is_internal;
...
void Meta_View_Type::impl::validate_set_fields( set< string >& fields_set, validation_error_container* p_validation_errors )
{
   ( void )fields_set;
...
void Meta_View_Type::impl::do_post_init( )
{
   // [<start do_post_init>]
   // [<finish do_post_init>]
}
...
void Meta_View_Type::validate( unsigned state, bool is_internal )
{
...
void Meta_View_Type::finalise_fetch( )
{
...
void Meta_View_Type::do_post_init( )
{
   p_impl->do_post_init( );
}
...
bool Meta_View_Type::is_file_field_name( const string& name ) const
{
...
const char* Meta_View_Type::class_id( ) const
{
   return static_class_id( );
}

const char* Meta_View_Type::class_name( ) const
{
   return static_class_name( );
}

const char* Meta_View_Type::plural_name( ) const
{
   return static_plural_name( );
}

const char* Meta_View_Type::module_id( ) const
{
   return static_module_id( );
}

const char* Meta_View_Type::module_name( ) const
{
...
void Meta_View_Type::do_generate_sql( generate_sql_type type, vector< string >& sql_stmts ) const
{
