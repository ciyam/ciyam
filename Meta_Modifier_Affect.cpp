...
void Meta_Modifier_Affect_command_functor::operator ( )( const string& command, const parameter_info& parameters )
{
   ...
   {
      bool want_fixed( has_parm_val( parameters, c_cmd_parm_Meta_Modifier_Affect_key_fixed ) );
   ...
   {
      string field_name( get_parm_val( parameters, c_cmd_parm_Meta_Modifier_Affect_cmd_field_name ) );
      string cmd_and_args( get_parm_val( parameters, c_cmd_parm_Meta_Modifier_Affect_cmd_cmd_and_args ) );
...
void Meta_Modifier_Affect::impl::validate( unsigned state, bool is_internal, validation_error_container* p_validation_errors )
{
   ( void )state;
   ( void )is_internal;
...
void Meta_Modifier_Affect::finalise_fetch( )
{
...
string Meta_Modifier_Affect::get_field_display_name( const string& id ) const
{
   string display_name;
...
void Meta_Modifier_Affect::do_generate_sql( generate_sql_type type, vector< string >& sql_stmts ) const
{
