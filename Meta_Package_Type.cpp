...
void Meta_Package_Type::impl::validate_set_fields( set< string >& fields_set, validation_error_container* p_validation_errors )
{
   ( void )fields_set;
...
void Meta_Package_Type::impl::get_required_transients( set< string >& names ) const
{
...
bool Meta_Package_Type::is_file_field_name( const string& name ) const
{
