...
class META_SPECIFICATION_TYPE_DECL_SPEC Meta_Specification_Type : public class_base
{
   ...
   enum field_id
   {
      ...
      e_field_id_Child_Prefix = 30,
      e_field_id_Child_Rel_Grandparent_Match = 31,
      e_field_id_Child_Rel_Parent_Match = 32,
      e_field_id_Child_Relationship_Class_Match = 33,
      e_field_id_Child_Specification_Type = 34,
      e_field_id_Default_Child_Vars = 35,
      e_field_id_Field_type = 36,
      e_field_id_Has_Next_Specification_Info = 37,
      e_field_id_Is_Child_Only = 38,
      e_field_id_Is_Required_For_UI_Gen = 39,
      e_field_id_Is_System = 40,
      e_field_id_Name = 41,
      e_field_id_Needs_Child_Relationship = 42,
      e_field_id_Needs_Class = 43,
      e_field_id_Needs_Enum = 44,
      e_field_id_Needs_Enum_Item = 45,
      e_field_id_Needs_Enum_Item_2 = 46,
      e_field_id_Needs_Enum_Item_3 = 47,
      e_field_id_Needs_Enum_Item_4 = 48,
      e_field_id_Needs_Enum_Item_5 = 49,
      e_field_id_Needs_Field = 50,
      e_field_id_Needs_Modifier = 51,
      e_field_id_Needs_Other_Class = 52,
      e_field_id_Needs_Other_Class_Field = 53,
      e_field_id_Needs_Other_Field = 54,
      e_field_id_Needs_Other_Field_2 = 55,
      e_field_id_Needs_Other_Modifier = 56,
      e_field_id_Needs_Other_Modifier_2 = 57,
      e_field_id_Needs_Other_Permission = 58,
      e_field_id_Needs_Other_Permission_2 = 59,
      e_field_id_Needs_Other_Procedure = 60,
      e_field_id_Needs_Other_Procedure_2 = 61,
      e_field_id_Needs_Other_Source_Child = 62,
      e_field_id_Needs_Other_Source_Child_2 = 63,
      e_field_id_Needs_Permission = 64,
      e_field_id_Needs_Procedure = 65,
      e_field_id_Needs_Procedure_Arg = 66,
      e_field_id_Needs_Procedure_Arg_2 = 67,
      e_field_id_Needs_Procedure_Arg_3 = 68,
      e_field_id_Needs_Source_Child = 69,
      e_field_id_Needs_Source_Field = 70,
      e_field_id_Needs_Source_Field_Or_Child = 71,
      e_field_id_Needs_Source_Parent = 72,
      e_field_id_Needs_Test_Field = 73,
      e_field_id_Needs_Test_Value = 74,
      e_field_id_Needs_Value = 75,
      e_field_id_Next_Child_Specification_Type = 76,
      e_field_id_Next_Protect_Child_Rel = 77,
      e_field_id_Next_Protect_Procedure = 78,
      e_field_id_Next_Protect_Source_Parent = 79,
      e_field_id_Next_Specification_Actions = 80,
      e_field_id_Notes = 81,
      e_field_id_Parent_Specification_Type = 82,
      e_field_id_Procedure_Arg_primitive = 83,
      e_field_id_Procedure_Arg_type = 84,
      e_field_id_Protect_Child_Rel_From_Update = 85,
      e_field_id_Protect_Class_From_Edit = 86,
      e_field_id_Protect_Class_From_Update = 87,
      e_field_id_Protect_Other_Class_From_Edit = 88,
      e_field_id_Protect_Procedure_From_Edit = 89,
      e_field_id_Protect_Source_Parent = 90,
      e_field_id_Set_Field_To_Source_Field_Or_Child = 91,
      e_field_id_Source_Field_Needs_Test_Field = 92,
      e_field_id_Source_Field_Type_Match = 93,
      e_field_id_Source_Parent_type = 94,
      e_field_id_Source_type = 95,
      e_field_id_Specification_Actions = 96,
      e_field_id_Specification_Name = 97,
      e_field_id_Specification_Object = 98,
      e_field_id_Specification_Strings = 99,
      e_field_id_Specification_Vars = 100,
      e_field_id_Test_Field_Type_Match = 101,
      e_field_id_Test_Field_type = 102,
      e_field_id_Use_Class_As_Source_Parent_Class = 103,
      e_field_id_Use_Field_Enum = 104,
      e_field_id_Use_Parent_Child_Rel_As_Source_Parent = 105,
      e_field_id_Use_Parent_Child_Rel_For_Class = 106,
      e_field_id_Use_Parent_Child_Rel_For_Other_Class = 107,
      e_field_id_Use_Parent_Class = 108,
      e_field_id_Use_Parent_Field_For_Class = 109,
      e_field_id_Use_Parent_Other_Class = 110,
      e_field_id_Use_Parent_Other_Class_For_Class = 111,
      e_field_id_Use_Parent_Procedure = 112,
      e_field_id_Use_Parent_Source_Class = 113,
      e_field_id_Use_Parent_Source_Field_For_Class = 114,
      e_field_id_Use_Parent_Source_Parent = 115,
      e_field_id_Use_Parent_Source_Parent_For_Class = 116,
      e_field_id_Use_Source_Field_Enum = 117,
      e_field_id_Use_Source_Field_Or_Child_Enum = 118,
      e_field_id_View_Id = 119
   };
