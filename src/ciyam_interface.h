...
const char* const c_display_admin_pin_number = "Admin Pin Number";
...
const char* const c_display_new_admin_pin_number = "New admin PIN is {@pin} (record this for use as the 'admin' Username).";
...
const char* const c_display_reset_master_password_2 = "You will need to correctly provide the mnemonics that you had originally written down.<br/><br/>Manually type in a new password then retype it in to verify it before then clicking the Confirm Identity button.";
