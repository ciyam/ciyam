...
const char* const c_display_unlock_message = "Enter unlock code or system identity password to unlock the application server.";
...
const char* const c_display_reset_admin_password_1 = "*** RESETTING ADMINISTRATION PASSWORD ***";
const char* const c_display_reset_admin_password_2 = "You will need to correctly provide the mnemonics that you had originally written down.<br/><br/>Manually type in a new password then retype it in to verify it before then clicking the Confirm Identity button.";
