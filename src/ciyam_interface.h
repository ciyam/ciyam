...
const char* const c_display_identity_introduction_1 = "If you are not restoring an existing system then you will need to write down the identity.<br/>NOTE: THIS SYSTEM CANNOT BE RESTORED IN THE FUTURE IF YOU FAIL TO DO THIS!";
const char* const c_display_identity_introduction_2 = "If you are restoring an existing system then you will need to type in the identity that you had originally written down.<br/><br/>Enter and then verify a password before then clicking the Confirm Identity button.";
