...
const char* const c_display_sign_up_main_form_client_security_introduction = "As CIYAM Open uses \"client side\" encryption your account credentials will be sent to you in a GPG encrypted message.";
