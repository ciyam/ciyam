...
const char* const c_display_your_gpg_encrypted_account_credentials = "Your GPG encrypted account credentials can now he copied to the clipboard from below ready for you to decode.";
