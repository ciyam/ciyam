...
const char* const c_display_backup_preparation = "Backup preparation currently in progress.";
...
const char* const c_display_restore_preparation = "Restore preparation currently in progress.";
