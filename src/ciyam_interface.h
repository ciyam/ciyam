...
const char* const c_display_identity_introduction_2 = "If you are restoring an existing system then you will need to type in the mnemonics that you had originally written down.<br/><br/>Manually type in a password then re-type it in to verify it before then clicking the Confirm Identity button.";
