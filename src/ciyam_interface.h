...
const char* const c_display_sign_up_main_form_client_security_gpg_expert_tip = "Know how to use GPG well and don't want to be sent an email?<br/><br/>Create a GPG key for \"anon@ciyam.org\" and your GPG encrypted credentials will be displayed in this page instead.";
