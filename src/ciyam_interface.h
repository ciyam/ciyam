...
const char* const c_display_reset_admin_password_2 = "You will need to correctly provide the mnemonics that you had originally written down.<br/><br/>Manually type in a password then retype it in to verify it before then clicking the Confirm Identity button.";
...
const char* const c_display_identity_introduction_2 = "If you are restoring an existing system then you will need to type in the mnemonics that you had originally written down.<br/><br/>Manually type in a password then retype it in to verify it before then clicking the Confirm Identity button.";
