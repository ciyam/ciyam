...
const char* const c_display_incorrect_pin = "PIN is incorrect - please check you device and try again";
...
const char* const c_display_need_gpg_public_for_single_email_address = "Please ensure that you use a GPG public key that is for a single email address only.";
