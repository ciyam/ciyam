...
const char* const c_identity_fingerprint = "@@identity_fingerprint";
...
const char* const c_display_identity_introduction_1 = "If you are not restoring or migrating then please copy and paste the value below for your records and be sure to make a backup of the file /usr/tux/ciyam/src/ciyam_server.sid (taking a backup of this file is critical for later being able to restore or migrate a CIYAM system).";
const char* const c_display_identity_introduction_2 = "If you are restoring or migrating then check that the value below matches that which you had originally recorded before clicking on the Confirm Identity button. If it doesn't then you will need to restore /usr/tux/ciyam/src/ciyam_server.sid from backup and then perform a retry.";
