...
string storage_channel_documents( const string& identity, bool get_height, bool for_fetched )
{
   ...
   if( ofs.has_folder( identity ) )
   {
      ...
      if( !get_height )
      {
         ...
         if( !get_session_variable( e_special_var_style_full_paths ).empty( ) )
      ...
      else if( !has_system_variable( opening_variable_name ) )
      {
         ...
         if( !opened_files_directory.empty( ) )
         {
            ...
            if( dir_exists( identity_directory ) )
            {
               ...
               temporary_session_variable tmp_style_full_paths( e_special_var_style_full_paths, c_true_value );
