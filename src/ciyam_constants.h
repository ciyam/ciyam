...
const size_t c_file_transfer_line_timeout = 10000; // i.e. 10 secs
const size_t c_file_transfer_initial_timeout = 15000; // i.e. 15 secs
...
const char* const c_file_type_core_data_header_version_number_prefix = "v=";
