Total index levels = 2
Total number of nodes = 23
Total number of items = 52

Dumping level #0
[Node 9] flags = 0, dge_link = 21
         lft_link = -1, rgt_link = -1
Item #0, data = aj, link = 2
Item #1, data = as, link = 8
Item #2, data = bb, link = 13
Item #3, data = bk, link = 17

Dumping level #1
[Node 2] flags = 0, dge_link = -1
         lft_link = -1, rgt_link = 8
Item #0, data = ad, link = 0
Item #1, data = ag, link = 1
Item #2, data = aj, link = 3

[Node 8] flags = 0, dge_link = -1
         lft_link = 2, rgt_link = 13
Item #0, data = am, link = 4
Item #1, data = ap, link = 5
Item #2, data = as, link = 6

[Node 13] flags = 0, dge_link = -1
         lft_link = 8, rgt_link = 17
Item #0, data = av, link = 7
Item #1, data = ay, link = 10
Item #2, data = bb, link = 11

[Node 17] flags = 0, dge_link = -1
         lft_link = 13, rgt_link = 21
Item #0, data = be, link = 12
Item #1, data = bh, link = 14
Item #2, data = bk, link = 15

[Node 21] flags = 0, dge_link = 22
         lft_link = 17, rgt_link = -1
Item #0, data = bn, link = 16
Item #1, data = bq, link = 18
Item #2, data = bt, link = 19
Item #3, data = bw, link = 20
