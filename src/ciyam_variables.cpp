...
const char* const c_special_variable_peer_offset_ext = "@peer_offset_ext";
const char* const c_special_variable_peer_offset_loc = "@peer_offset_loc";
...
string get_special_var_name( special_var var )
{
   ...
   switch( var )
   {
      ...
      case e_special_var_peer_offset_ext:
      s = string( c_special_variable_peer_offset_ext );
      break;

      case e_special_var_peer_offset_loc:
      s = string( c_special_variable_peer_offset_loc );
      break;
