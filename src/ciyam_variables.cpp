...
constexpr const char* c_special_variable_search = "@search";
...
constexpr const char* c_special_variable_replace = "@replace";
...
void init_special_variable_names( )
{
   ...
   if( g_special_variable_names.empty( ) )
   {
      ...
      g_special_variable_names.push_back( c_special_variable_search );
      ...
      g_special_variable_names.push_back( c_special_variable_replace );
