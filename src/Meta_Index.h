...
class Meta_Index : public class_base
{
   ...
   public:
   typedef Meta_Index class_type;

   enum field_id
   {
      e_field_id_none = 0,
      e_field_id_Class = 1,
      e_field_id_Field_1 = 2,
      e_field_id_Field_2 = 3,
      e_field_id_Field_3 = 4,
      e_field_id_Field_4 = 5,
      e_field_id_Field_5 = 6,
      e_field_id_Internal = 7,
      e_field_id_Order = 8,
      e_field_id_Source_Index = 9,
      e_field_id_Unique = 10
   };
   ...
   Meta_Field& Field_1( );
   const Meta_Field& Field_1( ) const;
   void Field_1( const std::string& key );

   Meta_Field& Field_2( );
   const Meta_Field& Field_2( ) const;
   void Field_2( const std::string& key );

   Meta_Field& Field_3( );
   const Meta_Field& Field_3( ) const;
   void Field_3( const std::string& key );

   Meta_Field& Field_4( );
   const Meta_Field& Field_4( ) const;
   void Field_4( const std::string& key );

   Meta_Field& Field_5( );
   const Meta_Field& Field_5( ) const;
   void Field_5( const std::string& key );

   Meta_Index& Source_Index( );
   const Meta_Index& Source_Index( ) const;
   void Source_Index( const std::string& key );

   Meta_Index& child_Index_Source( );
   const Meta_Index& child_Index_Source( ) const;
   ...
   static const char* static_class_id( ) { return "108100"; }
   static const char* static_class_name( ) { return "Index"; }
   static const char* static_plural_name( ) { return "Indexes"; }
   ...
   static void static_insert_external_alias( const std::string& module_and_class_id, Meta_Index* p_instance );
   static void static_remove_external_alias( const std::string& module_and_class_id );

   private:
   Meta_Index( const Meta_Index& );
   Meta_Index& operator =( const Meta_Index& );
   ...
   virtual void setup_foreign_key( Meta_Index& o, const std::string& value );
   ...
   virtual void setup_graph_parent( Meta_Index& o,
    const std::string& foreign_key_field, const std::string& init_value );
...
inline std::string to_string( const Meta_Index& c ) { return c.get_key( ); }

inline bool is_null( const Meta_Index& c ) { return c.get_key( ).empty( ); }

inline bool check_equal( const Meta_Index& c, const char* p ) { return c.get_key( ) == p; }
inline bool check_not_equal( const Meta_Index& c, const char* p ) { return !( c.get_key( ) == p ); }
