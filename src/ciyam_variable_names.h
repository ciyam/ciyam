...
enum special_var
{
   ...
   e_special_var_timezone,
   e_special_var_unlocked,
   ...
   e_special_var_auto_script,
   e_special_var_auto_update,
   ...
   e_special_var_trace_filters,
   e_special_var_update_fields,
   e_special_var_utm_init_base,
   e_special_var_cmd_delay_wait,
   e_special_var_force_internal,
   e_special_var_log_files_path,
   e_special_var_no_http_delays,
   ...
   e_special_var_script_executed,
   e_special_var_ssl_cert_issuer,
   ...
   e_special_var_style_full_paths,
   ...
   e_special_var_gteq_session_queue,
   e_special_var_repo_entry_missing,
   e_special_var_system_is_for_demo,
   e_special_var_system_is_for_devt,
   ...
   e_special_var_no_support_sessions,
   e_special_var_peer_identity_alias,
   e_special_var_repo_crypt_password,
   e_special_var_skip_parent_updates,
   e_special_var_supplied_expression,
   e_special_var_variable_expression,
   ...
   e_special_var_exporting_for_identity,
   ...
   e_special_var_blockchain_checked_skip,
