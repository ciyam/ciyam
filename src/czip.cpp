// Copyright (c) 2017-2019 CIYAM Developers
//
...
g_simple_tests[ ] =
{
   ...
   { "aaaaaaaa", "a\xf1\x07" },
   { "aaaaaaaaa", "a\xf1\x08" },
   { "aaaaaaaaaa", "a\xf1\x09" },
   { "aaaaaaaaaaa", "a\xf1\x0a" },
   { "aaaaaaaaaaaa", "a\xf1\x0b" },
   ...
   { "190", "190" },
   { "1908", "\xf1\x19\x08" },
   { "19082", "\xf2\x19\x08\x2f" },
   { "190827", "\xf2\x19\x08\x27\xff" },
   { "1908273", "\xf2\x19\x08\x27\x3f" },
   { "19082735", "\xf2\x19\x08\x27\x35\xff" },
   { "190827356", "\xf2\x19\x08\x27\x35\x6f" },
   { "1908273560", "\xf2\x19\x08\x27\x35\x60\xff" },
   { "19082735608", "\xf2\x19\x08\x27\x35\x60\x8f" },
   { "190827356082", "\xf2\x19\x08\x27\x35\x60\x82\xff" },
   { "1908273560825", "\xf2\x19\x08\x27\x35\x60\x82\x5f" },
   { "19082735608253", "\xf2\x19\x08\x27\x35\x60\x82\x53\xff" },
   { "190827356082539", "\xf2\x19\x08\x27\x35\x60\x82\x53\x9f" },
   { "and", "\xf3\x0a" },
   { "not", "\xf3\x97" },
   { "zes", "\xf3\xff" },
   { "And", "\xf4\x0a" },
