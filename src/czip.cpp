...
g_simple_tests[ ] =
{
   ...
   { "aaaaaaaaaa", "a\xf2""a\xf2" },
   { "aaaaaaaaaaa", "a\xf2""a\xf2""a" },
   { "aaaaaaaaaaaa", "a\xf2""a\xf2""aa" },
   { "aaaaaaaaaaaaa", "a\xf2""a\xf2""a\xf0" },
   { "aaaaaaaaaaaaaa", "a\xf2""a\xf2""a\xf1" },
   { "aaaaaaaaaaaaaaa", "a\xf2""a\xf2""a\xf2" },
   { "and", "\xf3\x0a" },
   { "not", "\xf3\x97" },
   { "zes", "\xf3\xff" },
   { "And", "\xf4\x0a" },
