...
void Meta_Modifier::impl::completed_fetch( bool skip_set_original )
{
...
void Meta_Modifier::completed_fetch( bool skip_set_original )
{
...
string Meta_Modifier::get_func_variable( const std::string& name ) const
{
