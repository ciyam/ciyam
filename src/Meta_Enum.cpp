...
void Meta_Enum::impl::completed_fetch( bool skip_set_original )
{
...
void Meta_Enum::completed_fetch( bool skip_set_original )
{
...
string Meta_Enum::get_func_variable( const std::string& name ) const
{
