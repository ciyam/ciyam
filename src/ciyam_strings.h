...
const char* const c_str_incorrect_password = "Incorrect in invalid password.";
...
const char* const c_str_storage_backup_underway = "Application is being prepared for backup.";
const char* const c_str_incomplete_restore_files = "Incomplete or missing file set for restore.";
...
const char* const c_str_storage_restore_underway = "Application is being prepared for restore.";
const char* const c_str_syncing_at_height_prefix = "Syncing at height ";
const char* const c_str_waiting_for_verification = "Waiting for verification";
...
const char* const c_str_restoring_extra_meta_records = "Restoring additional Meta records...";
...
const char* const c_str_waiting_for_peer_verification = "Waiting for peer verification";
