...
const char* const c_str_maximum_items_exceeded = "Maximum size for '@name' items may not be exceeded.";
const char* const c_str_maximum_items_exceeded_name = "@name";
...
const char* const c_str_maximum_items_are_queued = "Maximum number of items for '@name' are already queued.";
const char* const c_str_maximum_items_are_queued_name = "@name";
...
const char* const c_str_sytem_variable_is_in_use = "System variable '@name' is already in use.";
const char* const c_str_sytem_variable_is_in_use_name = "@name";
...
const char* const c_str_invalid_dynamic_var_store = "Invalid attempt to store dynamic system variable '@name'.";
const char* const c_str_invalid_dynamic_var_store_name = "@name";
...
const char* const c_str_invalid_read_only_var_store = "Invalid attempt to store read-only system variable '@variable'.";
const char* const c_str_invalid_read_only_var_store_variable = "@variable";
const char* const c_str_invalid_read_only_var_write = "Invalid attempt to change read-only system variable '@variable'.";
const char* const c_str_invalid_read_only_var_write_variable = "@variable";
