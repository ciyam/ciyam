...
void Meta_Package::impl::completed_fetch( bool skip_set_original )
{
...
void Meta_Package::completed_fetch( bool skip_set_original )
{
...
string Meta_Package::get_func_variable( const std::string& name ) const
{
