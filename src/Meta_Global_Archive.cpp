...
numeric g_default_Size_Limit = numeric( 100000000000 );
numeric g_default_Standard_Size_Limit = numeric( 100000000000 );
...
const numeric c_enum_archive_standard_size_300_GB( 300000000000 );
const numeric c_enum_archive_standard_size_500_GB( 500000000000 );
...
string get_enum_string_archive_standard_size( numeric val )
{
   ...
   else if( to_string( val ) == to_string( "300000000000" ) )
      string_name = "enum_archive_standard_size_300_GB";
   else if( to_string( val ) == to_string( "500000000000" ) )
      string_name = "enum_archive_standard_size_500_GB";
   else
...
void Meta_Global_Archive::impl::completed_fetch( bool skip_set_original )
{
...
void Meta_Global_Archive::completed_fetch( bool skip_set_original )
{
...
string Meta_Global_Archive::get_func_variable( const std::string& name ) const
{
...
void Meta_Global_Archive::static_class_init( const char* p_module_name )
{
   ...
   g_archive_standard_size_enum.insert( 300000000000 );
   g_archive_standard_size_enum.insert( 500000000000 );
