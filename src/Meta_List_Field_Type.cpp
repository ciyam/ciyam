...
void Meta_List_Field_Type::impl::validate_set_fields( set< string >& fields_set, validation_error_container* p_validation_errors )
{
   ( void )fields_set;
...
bool Meta_List_Field_Type::is_file_field_name( const string& name ) const
{
...
string Meta_List_Field_Type::get_field_uom_symbol( const string& id_or_name ) const
{
   ...
   else if( id_or_name == c_field_id_Allow_Link_Empty_Restriction || id_or_name == c_field_name_Allow_Link_Empty_Restriction )
   {
   ...
   else if( id_or_name == c_field_id_Allow_Link_Specifics || id_or_name == c_field_name_Allow_Link_Specifics )
   {
   ...
   else if( id_or_name == c_field_id_Allow_Sort_Manually || id_or_name == c_field_name_Allow_Sort_Manually )
   {
...
void Meta_List_Field_Type::do_generate_sql(
