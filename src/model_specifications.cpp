...
constexpr const char* c_arg_major = "-major";
constexpr const char* c_arg_annual = "-annual";
constexpr const char* c_arg_future = "-future";
constexpr const char* c_arg_reverse = "-reverse";
constexpr const char* c_arg_changing = "-changing";
constexpr const char* c_arg_negative = "-negative";
constexpr const char* c_arg_no_clear = "-no_clear";
constexpr const char* c_arg_new_only = "-new_only";
constexpr const char* c_arg_not_equal = "-not_equal";
constexpr const char* c_arg_for_store = "-for_store";
constexpr const char* c_arg_non_empty = "-non_empty";
constexpr const char* c_arg_transient = "-transient";
constexpr const char* c_arg_opt_prefix = "-opt_prefix";
constexpr const char* c_arg_self_child = "-self_child";
constexpr const char* c_arg_skip_nulls = "-skip_nulls";
constexpr const char* c_arg_check_null = "-check_null";
constexpr const char* c_arg_is_ui_only = "-is_ui_only";
constexpr const char* c_arg_not_create = "-not_create";
constexpr const char* c_arg_embed_links = "-embed_links";
constexpr const char* c_arg_exact_match = "-exact_match";
constexpr const char* c_arg_not_default = "-not_default";
constexpr const char* c_arg_create_only = "-create_only";
constexpr const char* c_arg_combine_keys = "-combine_keys";
constexpr const char* c_arg_grand_parent = "-grand_parent";
constexpr const char* c_arg_allow_internal = "-allow_internal";
constexpr const char* c_arg_include_clones = "-include_clones";
constexpr const char* c_arg_test_not_equal = "-test_not_equal";
constexpr const char* c_arg_include_default = "-include_default";

constexpr const char* c_arg_add_prefix = "-add=";
constexpr const char* c_arg_sep_prefix = "-sep=";
constexpr const char* c_arg_enum_prefix = "-enum=";
constexpr const char* c_arg_func_prefix = "-func=";
constexpr const char* c_arg_test_prefix = "-test=";
constexpr const char* c_arg_type_prefix = "-type=";
constexpr const char* c_arg_check_prefix = "-check=";
constexpr const char* c_arg_order_prefix = "-order=";
constexpr const char* c_arg_child_prefix = "-child=";
constexpr const char* c_arg_scope_prefix = "-scope=";
constexpr const char* c_arg_append_prefix = "-append=";
constexpr const char* c_arg_status_prefix = "-status=";
constexpr const char* c_arg_memfunc_prefix = "-memfunc=";
constexpr const char* c_arg_options_prefix = "-options=";
constexpr const char* c_arg_reverse_prefix = "-reverse=";
constexpr const char* c_arg_special_prefix = "-special=";
constexpr const char* c_arg_convertor_prefix = "-convertor=";
constexpr const char* c_arg_child_field_prefix = "-child_field=";
constexpr const char* c_arg_append_to_ext_prefix = "-append_to_ext=";

constexpr const char* c_attribute_amt = "amt";
constexpr const char* c_attribute_ext = "ext";
...
constexpr const char* c_attribute_limit = "limit";
constexpr const char* c_attribute_value = "value";
constexpr const char* c_attribute_period = "period";
constexpr const char* c_attribute_suffix = "suffix";
constexpr const char* c_attribute_add_amt = "add_amt";
constexpr const char* c_attribute_enum_id = "enum_id";
constexpr const char* c_attribute_add_type = "add_type";
constexpr const char* c_attribute_class_id = "class_id";
constexpr const char* c_attribute_field_id = "field_id";
constexpr const char* c_attribute_function = "function";
constexpr const char* c_attribute_mem_func = "mem_func";
constexpr const char* c_attribute_new_only = "new_only";
constexpr const char* c_attribute_not_null = "not_null";
constexpr const char* c_attribute_cclass_id = "cclass_id";
constexpr const char* c_attribute_is_annual = "is_annual";
constexpr const char* c_attribute_is_months = "is_months";
constexpr const char* c_attribute_cfield_id = "cfield_id";
constexpr const char* c_attribute_efield_id = "efield_id";
constexpr const char* c_attribute_fclass_id = "fclass_id";
constexpr const char* c_attribute_ffield_id = "ffield_id";
constexpr const char* c_attribute_gclass_id = "gclass_id";
constexpr const char* c_attribute_gfield_id = "gfield_id";
constexpr const char* c_attribute_mclass_id = "mclass_id";
constexpr const char* c_attribute_mfield_id = "mfield_id";
constexpr const char* c_attribute_pclass_id = "pclass_id";
constexpr const char* c_attribute_pfield_id = "pfield_id";
constexpr const char* c_attribute_nfield_id = "nfield_id";
constexpr const char* c_attribute_class1_id = "class1_id";
constexpr const char* c_attribute_class2_id = "class2_id";
constexpr const char* c_attribute_dfield_id = "dfield_id";
constexpr const char* c_attribute_field1_id = "field1_id";
constexpr const char* c_attribute_field2_id = "field2_id";
constexpr const char* c_attribute_for_store = "for_store";
constexpr const char* c_attribute_lfield_id = "lfield_id";
constexpr const char* c_attribute_ofield_id = "ofield_id";
constexpr const char* c_attribute_rfield_id = "rfield_id";
constexpr const char* c_attribute_sclass_id = "sclass_id";
constexpr const char* c_attribute_sfield_id = "sfield_id";
constexpr const char* c_attribute_tclass_id = "tclass_id";
constexpr const char* c_attribute_tfield_id = "tfield_id";
constexpr const char* c_attribute_uclass_id = "uclass_id";
constexpr const char* c_attribute_ufield_id = "ufield_id";
constexpr const char* c_attribute_xfield_id = "xfield_id";
constexpr const char* c_attribute_data_type = "data_type";
constexpr const char* c_attribute_new_value = "new_value";
constexpr const char* c_attribute_non_empty = "non_empty";
constexpr const char* c_attribute_not_equal = "not_equal";
constexpr const char* c_attribute_separator = "separator";
constexpr const char* c_attribute_convertor = "convertor";
constexpr const char* c_attribute_is_future = "is_future";
constexpr const char* c_attribute_check_null = "check_null";
constexpr const char* c_attribute_cpfield_id = "cpfield_id";
constexpr const char* c_attribute_data_value = "data_value";
constexpr const char* c_attribute_gpfield_id = "gpfield_id";
constexpr const char* c_attribute_is_reverse = "is_reverse";
constexpr const char* c_attribute_paclass_id = "paclass_id";
constexpr const char* c_attribute_pafield_id = "pafield_id";
constexpr const char* c_attribute_pfield1_id = "pfield1_id";
constexpr const char* c_attribute_pfield2_id = "pfield2_id";
constexpr const char* c_attribute_prfield_id = "prfield_id";
constexpr const char* c_attribute_scfield_id = "scfield_id";
constexpr const char* c_attribute_sfield1_id = "sfield1_id";
constexpr const char* c_attribute_sfield2_id = "sfield2_id";
constexpr const char* c_attribute_sfield3_id = "sfield3_id";
constexpr const char* c_attribute_spfield_id = "spfield_id";
constexpr const char* c_attribute_tcfield_id = "tcfield_id";
constexpr const char* c_attribute_tpfield_id = "tpfield_id";
constexpr const char* c_attribute_tvfield_id = "tvfield_id";
constexpr const char* c_attribute_is_ui_only = "is_ui_only";
constexpr const char* c_attribute_vdfield_id = "vdfield_id";
constexpr const char* c_attribute_vsfield_id = "vsfield_id";
constexpr const char* c_attribute_dest_value = "dest_value";
constexpr const char* c_attribute_null_value = "null_value";
constexpr const char* c_attribute_self_child = "self_child";
constexpr const char* c_attribute_skip_nulls = "skip_nulls";
constexpr const char* c_attribute_test_value = "test_value";
constexpr const char* c_attribute_field_info = "field_info";
constexpr const char* c_attribute_mpfield_id = "mpfield_id";
constexpr const char* c_attribute_pnfield_id = "pnfield_id";
constexpr const char* c_attribute_fkclass_id = "fkclass_id";
constexpr const char* c_attribute_fkfield_id = "fkfield_id";
constexpr const char* c_attribute_cffield_id = "cffield_id";
constexpr const char* c_attribute_not_create = "not_create";
constexpr const char* c_attribute_create_only = "create_only";
constexpr const char* c_attribute_crmfield_id = "crmfield_id";
constexpr const char* c_attribute_embed_links = "embed_links";
constexpr const char* c_attribute_field_id_id = "field_id_id";
constexpr const char* c_attribute_fkcclass_id = "fkcclass_id";
constexpr const char* c_attribute_fkcfield_id = "fkcfield_id";
constexpr const char* c_attribute_gcpfield_id = "gcpfield_id";
constexpr const char* c_attribute_is_changing = "is_changing";
constexpr const char* c_attribute_is_negative = "is_negative";
constexpr const char* c_attribute_mcrclass_id = "mcrclass_id";
constexpr const char* c_attribute_mcrfield_id = "mcrfield_id";
constexpr const char* c_attribute_mttfield_id = "mttfield_id";
constexpr const char* c_attribute_mtsfield_id = "mtsfield_id";
constexpr const char* c_attribute_pacfield_id = "pacfield_id";
constexpr const char* c_attribute_patfield_id = "patfield_id";
constexpr const char* c_attribute_pcfield1_id = "pcfield1_id";
constexpr const char* c_attribute_pcfield2_id = "pcfield2_id";
constexpr const char* c_attribute_pfkfield_id = "pfkfield_id";
constexpr const char* c_attribute_not_default = "not_default";
constexpr const char* c_attribute_field_value = "field_value";
constexpr const char* c_attribute_dfield_prim = "dfield_prim";
constexpr const char* c_attribute_dfield_type = "dfield_type";
constexpr const char* c_attribute_modifier_id = "modifier_id";
constexpr const char* c_attribute_sftfield_id = "sftfield_id";
constexpr const char* c_attribute_act_field_id = "act_field_id";
constexpr const char* c_attribute_action_value = "action_value";
constexpr const char* c_attribute_append_value = "append_value";
constexpr const char* c_attribute_combine_keys = "combine_keys";
constexpr const char* c_attribute_crpmfield_id = "crpmfield_id";
constexpr const char* c_attribute_dtm_field_id = "dtm_field_id";
constexpr const char* c_attribute_field_key_id = "field_key_id";
constexpr const char* c_attribute_fkcffield_id = "fkcffield_id";
constexpr const char* c_attribute_is_transient = "is_transient";
constexpr const char* c_attribute_mcrcfield_id = "mcrcfield_id";
constexpr const char* c_attribute_options_left = "options_left";
constexpr const char* c_attribute_procedure_id = "procedure_id";
constexpr const char* c_attribute_protect_spec = "protect_spec";
constexpr const char* c_attribute_pw_enum_name = "pw_enum_name";
constexpr const char* c_attribute_status_value = "status_value";
constexpr const char* c_attribute_tfield_value = "tfield_value";
constexpr const char* c_attribute_ug_enum_name = "ug_enum_name";
constexpr const char* c_attribute_uid_field_id = "uid_field_id";
constexpr const char* c_attribute_append_to_ext = "append_to_ext";
constexpr const char* c_attribute_auto_class_id = "auto_class_id";
constexpr const char* c_attribute_crgpmfield_id = "crgpmfield_id";
constexpr const char* c_attribute_default_value = "default_value";
constexpr const char* c_attribute_dtm2_field_id = "dtm2_field_id";
constexpr const char* c_attribute_link_class_id = "link_class_id";
constexpr const char* c_attribute_mask_field_id = "mask_field_id";
constexpr const char* c_attribute_next_field_id = "next_field_id";
constexpr const char* c_attribute_opt_field2_id = "opt_field2_id";
constexpr const char* c_attribute_options_right = "options_right";
constexpr const char* c_attribute_protect_value = "protect_value";
constexpr const char* c_attribute_protect_scope = "protect_scope";
constexpr const char* c_attribute_pw_enum_value = "pw_enum_value";
constexpr const char* c_attribute_special_value = "special_value";
constexpr const char* c_attribute_src_field2_id = "src_field2_id";
constexpr const char* c_attribute_type_field_id = "type_field_id";
constexpr const char* c_attribute_test_field_id = "test_field_id";
constexpr const char* c_attribute_task_class_id = "task_class_id";
constexpr const char* c_attribute_ug_enum_value = "ug_enum_value";
constexpr const char* c_attribute_uid2_field_id = "uid2_field_id";
constexpr const char* c_attribute_user_info_key = "user_info_key";
constexpr const char* c_attribute_allow_internal = "allow_internal";
constexpr const char* c_attribute_child_class_id = "child_class_id";
constexpr const char* c_attribute_child_field_id = "child_field_id";
constexpr const char* c_attribute_extra_field_id = "extra_field_id";
constexpr const char* c_attribute_field_field_id = "field_field_id";
constexpr const char* c_attribute_has_opt_prefix = "has_opt_prefix";
constexpr const char* c_attribute_include_clones = "include_clones";
constexpr const char* c_attribute_is_exact_match = "is_exact_match";
constexpr const char* c_attribute_opt_prefix2_id = "opt_prefix2_id";
constexpr const char* c_attribute_order_field_id = "order_field_id";
constexpr const char* c_attribute_pw_enum_2_name = "pw_enum_2_name";
constexpr const char* c_attribute_restrict_value = "restrict_value";
constexpr const char* c_attribute_test_not_equal = "test_not_equal";
constexpr const char* c_attribute_test2_field_id = "test2_field_id";
constexpr const char* c_attribute_child_pclass_id = "child_pclass_id";
constexpr const char* c_attribute_child_pfield_id = "child_pfield_id";
constexpr const char* c_attribute_enum_value_name = "enum_value_name";
constexpr const char* c_attribute_extra_sfield_id = "extra_sfield_id";
constexpr const char* c_attribute_include_default = "include_default";
constexpr const char* c_attribute_is_grand_parent = "is_grand_parent";
constexpr const char* c_attribute_pw_enum_2_value = "pw_enum_2_value";
constexpr const char* c_attribute_prefix_class_id = "prefix_class_id";
constexpr const char* c_attribute_prefix_field_id = "prefix_field_id";
constexpr const char* c_attribute_status_field_id = "status_field_id";
constexpr const char* c_attribute_suffix_class_id = "suffix_class_id";
constexpr const char* c_attribute_suffix_field_id = "suffix_field_id";
constexpr const char* c_attribute_relationship_id = "relationship_id";
constexpr const char* c_attribute_source_class_id = "source_class_id";
constexpr const char* c_attribute_source_field_cid = "source_field_cid";
constexpr const char* c_attribute_neq_status_value = "neq_status_value";
constexpr const char* c_attribute_version_field_id = "version_field_id";
constexpr const char* c_attribute_special_field_id = "special_field_id";
constexpr const char* c_attribute_special_class_id = "special_class_id";
constexpr const char* c_attribute_cfk_from_field_id = "cfk_from_field_id";
constexpr const char* c_attribute_internal_field_id = "internal_field_id";
constexpr const char* c_attribute_special_cfield_id = "special_cfield_id";
constexpr const char* c_attribute_source_field_value = "source_field_value";
constexpr const char* c_attribute_exhausted_field_id = "exhausted_field_id";
constexpr const char* c_attribute_neq_status_field_id = "neq_status_field_id";
constexpr const char* c_attribute_move_up_procedure_id = "move_up_procedure_id";
constexpr const char* c_attribute_move_up_fields_arg_id = "move_up_fields_args_id";
constexpr const char* c_attribute_move_up_values_arg_id = "move_up_values_args_id";
constexpr const char* c_attribute_increment_procedure_id = "increment_procedure_id";
constexpr const char* c_attribute_move_down_procedure_id = "move_down_procedure_id";
constexpr const char* c_attribute_special_extra_class_id = "special_extra_class_id";
constexpr const char* c_attribute_special_extra_source_id = "special_extra_source_id";
constexpr const char* c_attribute_move_down_fields_arg_id = "move_down_fields_args_id";
constexpr const char* c_attribute_move_down_values_arg_id = "move_down_values_args_id";
constexpr const char* c_attribute_special_extra_field_info = "special_extra_field_info";
constexpr const char* c_attribute_increment_next_value_arg_id = "increment_next_value_arg_id";

constexpr const char* c_attribute_class1_fld_id = "class1_fld_id";
constexpr const char* c_attribute_class1_fk_id = "class1_fk_id";
constexpr const char* c_attribute_class2_fld_id = "class2_fld_id";
constexpr const char* c_attribute_class2_fk_id = "class2_fk_id";
constexpr const char* c_attribute_class1_fk2_id = "class1_fk2_id";
constexpr const char* c_attribute_class2_fk2_id = "class2_fk2_id";
constexpr const char* c_attribute_class1_fk_cid = "class1_fk_cid";
constexpr const char* c_attribute_class2_fk_cid = "class2_fk_cid";
constexpr const char* c_attribute_class1_fk2_cid = "class1_fk2_cid";
constexpr const char* c_attribute_class2_fk2_cid = "class2_fk2_cid";
constexpr const char* c_attribute_class1_fk_value = "class1_fk_value";
constexpr const char* c_attribute_class1_fk_title = "class1_fk_title";
constexpr const char* c_attribute_class2_fk_value = "class2_fk_value";
constexpr const char* c_attribute_class2_fk_title = "class2_fk_title";
constexpr const char* c_attribute_class1_fk2_value = "class1_fk2_value";
constexpr const char* c_attribute_class1_fk2_title = "class1_fk2_title";
constexpr const char* c_attribute_class2_fk2_value = "class2_fk2_value";
constexpr const char* c_attribute_class2_fk2_title = "class2_fk2_title";
constexpr const char* c_attribute_test_field_value = "test_field_value";
constexpr const char* c_attribute_task_pv_field_id = "task_pv_field_id";
constexpr const char* c_attribute_test2_field_value = "test2_field_value";
constexpr const char* c_attribute_major_version_only = "major_version_only";

constexpr const char* c_data_amt = "amt";
constexpr const char* c_data_cid = "cid";
constexpr const char* c_data_ext = "ext";
constexpr const char* c_data_key = "key";
constexpr const char* c_data_func = "func";
constexpr const char* c_data_name = "name";
constexpr const char* c_data_type = "type";
constexpr const char* c_data_child = "child";
constexpr const char* c_data_class = "class";
constexpr const char* c_data_dtype = "dtype";
constexpr const char* c_data_field = "field";
constexpr const char* c_data_label = "label";
constexpr const char* c_data_limit = "limit";
constexpr const char* c_data_mfunc = "mfunc";
constexpr const char* c_data_value = "value";
constexpr const char* c_data_uikey = "uikey";
constexpr const char* c_data_annual = "annual";
constexpr const char* c_data_append = "append";
constexpr const char* c_data_cclass = "cclass";
constexpr const char* c_data_evalue = "evalue";
constexpr const char* c_data_fclass = "fclass";
constexpr const char* c_data_gchild = "gchild";
constexpr const char* c_data_gclass = "gclass";
constexpr const char* c_data_mclass = "mclass";
constexpr const char* c_data_oclass = "oclass";
constexpr const char* c_data_months = "months";
constexpr const char* c_data_period = "period";
constexpr const char* c_data_cfield = "cfield";
constexpr const char* c_data_dfield = "dfield";
constexpr const char* c_data_dfprim = "dfprim";
constexpr const char* c_data_dftype = "dftype";
constexpr const char* c_data_dvalue = "dvalue";
constexpr const char* c_data_efield = "efield";
constexpr const char* c_data_ffield = "ffield";
constexpr const char* c_data_field1 = "field1";
constexpr const char* c_data_field2 = "field2";
constexpr const char* c_data_fields = "fields";
constexpr const char* c_data_future = "future";
constexpr const char* c_data_gfield = "gfield";
constexpr const char* c_data_ifield = "ifield";
constexpr const char* c_data_is_neg = "is_neg";
constexpr const char* c_data_mfield = "mfield";
constexpr const char* c_data_nvalue = "nvalue";
...
constexpr const char* c_data_not_eq = "not_eq";
constexpr const char* c_data_lfield = "lfield";
constexpr const char* c_data_ofield = "ofield";
constexpr const char* c_data_oleftb = "oleftb";
constexpr const char* c_data_pfield = "pfield";
constexpr const char* c_data_prefix = "prefix";
constexpr const char* c_data_pwname = "pwname";
constexpr const char* c_data_rfield = "rfield";
constexpr const char* c_data_sclass = "sclass";
constexpr const char* c_data_sfield = "sfield";
constexpr const char* c_data_static = "static";
constexpr const char* c_data_suffix = "suffix";
constexpr const char* c_data_tfield = "tfield";
constexpr const char* c_data_tvalue = "tvalue";
constexpr const char* c_data_uclass = "uclass";
constexpr const char* c_data_ufield = "ufield";
constexpr const char* c_data_ugname = "ugname";
constexpr const char* c_data_xfield = "xfield";
constexpr const char* c_data_add_amt = "add_amt";
constexpr const char* c_data_cffield = "cffield";
constexpr const char* c_data_command = "command";
constexpr const char* c_data_cpclass = "cpclass";
constexpr const char* c_data_cpfield = "cpfield";
constexpr const char* c_data_dn_proc = "dn_proc";
constexpr const char* c_data_fkchild = "fkchild";
constexpr const char* c_data_fkclass = "fkclass";
constexpr const char* c_data_fkfield = "fkfield";
constexpr const char* c_data_gpfield = "gpfield";
constexpr const char* c_data_idfield = "idfield";
constexpr const char* c_data_mpfield = "mpfield";
constexpr const char* c_data_new_val = "new_val";
constexpr const char* c_data_not_new = "not_new";
constexpr const char* c_data_ofield2 = "ofield2";
constexpr const char* c_data_orightb = "orightb";
constexpr const char* c_data_pafield = "pafield";
constexpr const char* c_data_pfield1 = "pfield1";
constexpr const char* c_data_pfield2 = "pfield2";
constexpr const char* c_data_pnfield = "pnfield";
constexpr const char* c_data_prefix2 = "prefix2";
constexpr const char* c_data_prfield = "prfield";
constexpr const char* c_data_pvchild = "pvchild";
constexpr const char* c_data_pwname2 = "pwname2";
constexpr const char* c_data_pwvalue = "pwvalue";
constexpr const char* c_data_reverse = "reverse";
constexpr const char* c_data_scclass = "scclass";
constexpr const char* c_data_scfield = "scfield";
constexpr const char* c_data_sfield1 = "sfield1";
constexpr const char* c_data_sfield2 = "sfield2";
constexpr const char* c_data_sfield3 = "sfield3";
constexpr const char* c_data_sfclass = "sfclass";
constexpr const char* c_data_sfvalue = "sfvalue";
constexpr const char* c_data_spfield = "spfield";
constexpr const char* c_data_tcfield = "tcfield";
constexpr const char* c_data_tpfield = "tpfield";
constexpr const char* c_data_tvfield = "tvfield";
constexpr const char* c_data_ugvalue = "ugvalue";
constexpr const char* c_data_up_proc = "up_proc";
constexpr const char* c_data_vdfield = "vdfield";
constexpr const char* c_data_vsfield = "vsfield";
constexpr const char* c_data_xsfield = "xsfield";
constexpr const char* c_data_add_type = "add_type";
constexpr const char* c_data_changing = "changing";
constexpr const char* c_data_chk_null = "chk_null";
constexpr const char* c_data_cmd_args = "cmd_args";
constexpr const char* c_data_crmfield = "crmfield";
constexpr const char* c_data_fidfield = "fidfield";
constexpr const char* c_data_fkcclass = "fkcclass";
constexpr const char* c_data_fkcfield = "fkcfield";
constexpr const char* c_data_mcrfield = "mcrfield";
constexpr const char* c_data_mttfield = "mttfield";
constexpr const char* c_data_mtsfield = "mtsfield";
constexpr const char* c_data_pcfield1 = "pcfield1";
constexpr const char* c_data_pcfield2 = "pcfield2";
constexpr const char* c_data_pfkfield = "pfkfield";
constexpr const char* c_data_pwvalue2 = "pwvalue2";
constexpr const char* c_data_test_neq = "test_neq";
constexpr const char* c_data_cvt_func = "cvt_func";
constexpr const char* c_data_inc_dflt = "inc_dflt";
constexpr const char* c_data_inc_proc = "inc_proc";
constexpr const char* c_data_keyfield = "keyfield";
constexpr const char* c_data_modifier = "modifier";
constexpr const char* c_data_new_only = "new_only";
constexpr const char* c_data_not_null = "not_null";
constexpr const char* c_data_pacfield = "pacfield";
constexpr const char* c_data_patfield = "patfield";
constexpr const char* c_data_root_key = "root_key";
constexpr const char* c_data_sftfield = "sftfield";
constexpr const char* c_data_not_dflt = "not_dflt";
constexpr const char* c_data_act_field = "act_field";
constexpr const char* c_data_crpmfield = "crpmfield";
constexpr const char* c_data_dn_fields = "dn_fields";
constexpr const char* c_data_dn_values = "dn_values";
constexpr const char* c_data_fkcffield = "fkcffield";
constexpr const char* c_data_for_store = "for_store";
constexpr const char* c_data_mcrcfield = "mcrcfield";
constexpr const char* c_data_non_empty = "non_empty";
constexpr const char* c_data_separator = "separator";
constexpr const char* c_data_transient = "transient";
constexpr const char* c_data_inc_value = "inc_value";
constexpr const char* c_data_up_fields = "up_fields";
constexpr const char* c_data_up_values = "up_values";
constexpr const char* c_data_ver_field = "ver_field";
constexpr const char* c_data_procedure = "procedure";
constexpr const char* c_data_spec_file = "spec_file";
constexpr const char* c_data_crgpmfield = "crgpmfield";
constexpr const char* c_data_fmandatory = "fmandatory";
constexpr const char* c_data_ftransient = "ftransient";
constexpr const char* c_data_is_testval = "is_testval";
constexpr const char* c_data_is_ui_only = "is_ui_only";
constexpr const char* c_data_link_class = "link_class";
constexpr const char* c_data_mask_field = "mask_field";
constexpr const char* c_data_next_field = "next_field";
constexpr const char* c_data_not_create = "not_create";
constexpr const char* c_data_opt_prefix = "opt_prefix";
constexpr const char* c_data_self_child = "self_child";
constexpr const char* c_data_spec_value = "spec_value";
constexpr const char* c_data_spec_scope = "spec_scope";
constexpr const char* c_data_auto_class = "auto_class";
constexpr const char* c_data_inc_clones = "inc_clones";
constexpr const char* c_data_after_store = "after_store";
constexpr const char* c_data_child_class = "child_class";
constexpr const char* c_data_child_field = "child_field";
constexpr const char* c_data_create_only = "create_only";
constexpr const char* c_data_embed_links = "embed_links";
constexpr const char* c_data_exact_match = "exact_match";
constexpr const char* c_data_fistexttype = "fistexttype";
constexpr const char* c_data_order_field = "order_field";
constexpr const char* c_data_combine_keys = "combine_keys";
constexpr const char* c_data_grand_parent = "grand_parent";
constexpr const char* c_data_status_field = "status_field";
constexpr const char* c_data_status_value = "status_value";
constexpr const char* c_data_append_to_ext = "append_to_ext";
constexpr const char* c_data_sfistexttype = "sfistexttype";
constexpr const char* c_data_tfistexttype = "tfistexttype";
constexpr const char* c_data_fk_from_child = "fk_from_child";
constexpr const char* c_data_primary_class = "primary_class";
constexpr const char* c_data_scfistexttype = "scfistexttype";
constexpr const char* c_data_special_value = "special_value";
constexpr const char* c_data_special_field = "special_field";
constexpr const char* c_data_tcfistexttype = "tcfistexttype";
constexpr const char* c_data_special_cfield = "special_cfield";
constexpr const char* c_data_exhausted_field = "exhausted_field";
constexpr const char* c_data_secondary_class = "secondary_class";
constexpr const char* c_data_neq_status_field = "neq_status_field";
constexpr const char* c_data_neq_status_value = "neq_status_value";
constexpr const char* c_data_dtm_field = "dtm_field";
constexpr const char* c_data_dtm2_field = "dtm2_field";
constexpr const char* c_data_uid_field = "uid_field";
constexpr const char* c_data_uid2_field = "uid2_field";
constexpr const char* c_data_file_field = "file_field";
constexpr const char* c_data_test_field = "test_field";
constexpr const char* c_data_test_value = "test_value";
constexpr const char* c_data_task_class = "task_class";
constexpr const char* c_data_field_list = "field_list";
constexpr const char* c_data_major_only = "major_only";
constexpr const char* c_data_skip_nulls = "skip_nulls";
constexpr const char* c_data_allow_internal = "allow_internal";
constexpr const char* c_data_dummy_procedure = "dummy_procedure";
constexpr const char* c_data_special_extra_source = "special_extra_source";
constexpr const char* c_data_primary_stats1_cclass = "primary_stats1_cclass";
constexpr const char* c_data_primary_stats2_cclass = "primary_stats2_cclass";
constexpr const char* c_data_primary_stats1_cfield = "primary_stats1_cfield";
constexpr const char* c_data_primary_stats2_cfield = "primary_stats2_cfield";
constexpr const char* c_data_primary_stats1_class1 = "primary_stats1_class1";
constexpr const char* c_data_primary_stats1_field1 = "primary_stats1_field1";
constexpr const char* c_data_primary_stats1_value1 = "primary_stats1_value1";
constexpr const char* c_data_primary_stats2_class1 = "primary_stats2_class1";
constexpr const char* c_data_primary_stats2_field1 = "primary_stats2_field1";
constexpr const char* c_data_primary_stats2_value1 = "primary_stats2_value1";
constexpr const char* c_data_primary_stats1_class2 = "primary_stats1_class2";
constexpr const char* c_data_primary_stats1_field2 = "primary_stats1_field2";
constexpr const char* c_data_primary_stats1_value2 = "primary_stats1_value2";
constexpr const char* c_data_primary_stats2_class2 = "primary_stats2_class2";
constexpr const char* c_data_primary_stats2_field2 = "primary_stats2_field2";
constexpr const char* c_data_primary_stats2_value2 = "primary_stats2_value2";
constexpr const char* c_data_secondary_stats1_cclass = "secondary_stats1_cclass";
constexpr const char* c_data_secondary_stats2_cclass = "secondary_stats2_cclass";
constexpr const char* c_data_secondary_stats1_cfield = "secondary_stats1_cfield";
constexpr const char* c_data_secondary_stats2_cfield = "secondary_stats2_cfield";
constexpr const char* c_data_secondary_stats1_class1 = "secondary_stats1_class1";
constexpr const char* c_data_secondary_stats1_field1 = "secondary_stats1_field1";
constexpr const char* c_data_secondary_stats1_value1 = "secondary_stats1_value1";
constexpr const char* c_data_secondary_stats2_class1 = "secondary_stats2_class1";
constexpr const char* c_data_secondary_stats2_field1 = "secondary_stats2_field1";
constexpr const char* c_data_secondary_stats2_value1 = "secondary_stats2_value1";
constexpr const char* c_data_secondary_stats1_class2 = "secondary_stats1_class2";
constexpr const char* c_data_secondary_stats1_field2 = "secondary_stats1_field2";
constexpr const char* c_data_secondary_stats1_value2 = "secondary_stats1_value2";
constexpr const char* c_data_secondary_stats2_class2 = "secondary_stats2_class2";
constexpr const char* c_data_secondary_stats2_field2 = "secondary_stats2_field2";
constexpr const char* c_data_secondary_stats2_value2 = "secondary_stats2_value2";
constexpr const char* c_data_special_extra_field_info = "special_extra_field_info";
...
void check_cond_non_null_specification::add( model& m, const vector< string >& args, vector< specification_detail >& details )
{
   ...
   for( size_t arg = 3; arg < args.size( ); arg++ )
   {
      ...
      if( next_arg == string( c_arg_negative ) )
         ...
         test_field_info = next_arg.substr( CONST_LENGTH( c_arg_test_prefix ) );
      else
...
void copy_child_links_from_fk_specification::add( model& m, const vector< string >& args, vector< specification_detail >& details )
{
   ...
   for( size_t arg = 5; arg < args.size( ); arg++ )
   {
      ...
      if( next_arg == c_arg_not_create )
         ...
         arg_fk_child_field = next_arg.substr( CONST_LENGTH( c_arg_child_field_prefix ) );
      else
...
void default_from_key_specification::add( model& m, const vector< string >& args, vector< specification_detail >& details )
{
   ...
   for( size_t arg = 2; arg < args.size( ); arg++ )
   {
      ...
      if( next_arg == c_arg_for_store )
         ...
         append_value = next_arg.substr( CONST_LENGTH( c_arg_append_prefix ) );
      else if( next_arg.find( c_arg_func_prefix ) == 0 )
         transform_func = next_arg.substr( CONST_LENGTH( c_arg_func_prefix ) );
      else
...
void default_to_field_specification::add( model& m, const vector< string >& args, vector< specification_detail >& details )
{
   ...
   for( size_t arg = 3; arg < args.size( ); arg++ )
   {
      ...
      if( next_arg == c_arg_for_store )
         ...
         convertor = next_arg.substr( CONST_LENGTH( c_arg_convertor_prefix ) );
      else
...
void default_to_global_specification::add( model& m, const vector< string >& args, vector< specification_detail >& details )
{
   ...
   for( size_t arg = 3; arg < args.size( ); arg++ )
   {
      ...
      if( next_arg.find( c_arg_test_prefix ) == 0 )
         ...
         check_field_name = next_arg.substr( CONST_LENGTH( c_arg_check_prefix ) );
...
void field_from_acyclic_path_specification::add( model& m, const vector< string >& args, vector< specification_detail >& details )
{
   ...
   for( size_t i = 4; i < args.size( ); i++ )
   {
      ...
      if( next_arg == c_arg_embed_links )
         ...
         separator = next_arg.substr( CONST_LENGTH( c_arg_sep_prefix ) );
      else
...
void field_from_concatenation_specification::add( model& m, const vector< string >& args, vector< specification_detail >& details )
{
   ...
   for( size_t arg = 3; arg < args.size( ); arg++ )
   {
      ...
      {
         arg_sep = next_arg.substr( CONST_LENGTH( c_arg_sep_prefix ) );
...
void field_from_other_field_specification::add( model& m, const vector< string >& args, vector< specification_detail >& details )
{
   ...
   for( size_t arg = 3; arg < args.size( ); arg++ )
   {
      ...
      if( next_arg == c_arg_for_store )
         ...
         function = next_arg.substr( CONST_LENGTH( c_arg_func_prefix ) );
      else if( next_arg.find( c_arg_test_prefix ) == 0 )
         test_info = next_arg.substr( CONST_LENGTH( c_arg_test_prefix ) );
      else if( next_arg.find( c_arg_memfunc_prefix ) == 0 )
         mem_func = next_arg.substr( CONST_LENGTH( c_arg_memfunc_prefix ) );
...
void field_from_other_field_specification::add_specification_data( model& m, specification_data& spec_data ) const
{
   ...
   spec_data.data_pairs.push_back( make_pair( "oprocedure", "" ) );
...
void field_from_search_replace_specification::add( model& m, const vector< string >& args, vector< specification_detail >& details )
{
   ...
   for( size_t arg = 4; arg < args.size( ); arg++ )
   {
      ...
      if( next_arg.find( c_arg_sep_prefix ) == 0 )
      {
         ...
         options_info = next_arg.substr( CONST_LENGTH( c_arg_options_prefix ) );
      else
...
void file_link_specification::add( model& m, const vector< string >& args, vector< specification_detail >& details )
{
   ...
   for( size_t arg = 4; arg < args.size( ); arg++ )
   {
      ...
      if( next_arg.find( c_arg_append_to_ext_prefix ) == 0 )
         append_to_ext = next_arg.substr( CONST_LENGTH( c_arg_append_to_ext_prefix ) );
...
void fk_link_first_child_specification::add( model& m, const vector< string >& args, vector< specification_detail >& details )
{
   ...
   for( size_t arg = 3; arg < args.size( ); arg++ )
   {
      ...
      if( next_arg.find( c_arg_order_prefix ) == 0 )
         arg_order_info = next_arg.substr( CONST_LENGTH( c_arg_order_prefix ) );
      else if( next_arg.find( c_arg_status_prefix ) == 0 )
         arg_status_info = next_arg.substr( CONST_LENGTH( c_arg_status_prefix ) );
...
void modifier_field_value_specification::add( model& m, const vector< string >& args, vector< specification_detail >& details )
{
   ...
   for( size_t arg = 4; arg < args.size( ); arg++ )
   {
      ...
      if( next_arg.find( c_arg_enum_prefix ) == 0 )
         enum_name = next_arg.substr( CONST_LENGTH( c_arg_enum_prefix ) );
      else if( next_arg.find( c_arg_test_prefix ) == 0 )
         test_field_info = next_arg.substr( CONST_LENGTH( c_arg_test_prefix ) );
...
void modifier_past_date_time_specification::add( model& m, const vector< string >& args, vector< specification_detail >& details )
{
   ...
   for( size_t arg = 3; arg < args.size( ); arg++ )
   {
      ...
      if( next_arg == string( c_arg_future ) && !is_future )
         ...
         arg_add_info = next_arg.substr( CONST_LENGTH( c_arg_add_prefix ) );
      else if( next_arg.find( c_arg_test_prefix ) == 0 )
         arg_test_info = next_arg.substr( CONST_LENGTH( c_arg_test_prefix ) );
      else if( next_arg.find( c_arg_type_prefix ) == 0 )
         arg_dfield_type = next_arg.substr( CONST_LENGTH( c_arg_type_prefix ) );
      else
...
void parent_field_from_other_specification::add( model& m, const vector< string >& args, vector< specification_detail >& details )
{
   ...
   for( size_t arg = 4; arg < args.size( ); arg++ )
   {
      ...
      if( next_arg.find( c_arg_test_prefix ) == 0 )
         tfield_info = next_arg.substr( CONST_LENGTH( c_arg_test_prefix ) );
      else
...
void state_protect_specification::add( model& m, const vector< string >& args, vector< specification_detail >& details )
{
   ...
   for( size_t arg = 4; arg < args.size( ); arg++ )
   {
      ...
      if( next_arg == c_arg_is_ui_only )
         ...
         arg_protect_scope = next_arg.substr( CONST_LENGTH( c_arg_scope_prefix ) );
      else
...
void transient_field_concat_specification::add( model& m, const vector< string >& args, vector< specification_detail >& details )
{
   ...
   for( size_t arg = 4; arg < args.size( ); arg++ )
   {
      ...
      if( !is_reverse && next_arg == string( c_arg_reverse ) )
         ...
         arg_cfield_name = next_arg.substr( CONST_LENGTH( c_arg_child_prefix ) );
      else if( next_arg.find( c_arg_reverse_prefix ) == 0 )
         arg_rfield_name = next_arg.substr( CONST_LENGTH( c_arg_reverse_prefix ) );
      else
