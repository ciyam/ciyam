...
#ifndef META_MODIFIER_AFFECT_H
#  define META_MODIFIER_AFFECT_H
...
class Meta_Modifier_Affect : public class_base
{
   ...
   public:
   typedef Meta_Modifier_Affect class_type;
   ...
   enum field_id
   {
      ...
      e_field_id_Extra = 2,
      e_field_id_Field = 3,
      e_field_id_Internal = 4,
      e_field_id_Modifier = 5,
      e_field_id_Scope = 6,
      e_field_id_Source_Modifier_Affect = 7,
      e_field_id_Type = 8
   };

   Meta_Modifier_Affect( );
   ~Meta_Modifier_Affect( );
   ...
   Meta_Modifier_Affect& Source_Modifier_Affect( );
   const Meta_Modifier_Affect& Source_Modifier_Affect( ) const;
   void Source_Modifier_Affect( const std::string& key );

   Meta_Modifier_Affect& child_Modifier_Affect_Source( );
   const Meta_Modifier_Affect& child_Modifier_Affect_Source( ) const;
   ...
   static const char* static_class_id( ) { return "110100"; }
   static const char* static_class_name( ) { return "Modifier_Affect"; }
   static const char* static_plural_name( ) { return "Modifier_Affects"; }
   ...
   static void static_insert_external_alias( const std::string& module_and_class_id, Meta_Modifier_Affect* p_instance );
   static void static_remove_external_alias( const std::string& module_and_class_id );

   private:
   Meta_Modifier_Affect( const Meta_Modifier_Affect& );
   Meta_Modifier_Affect& operator =( const Meta_Modifier_Affect& );
   ...
   virtual void setup_foreign_key( Meta_Modifier_Affect& o, const std::string& value );
   ...
   virtual void setup_graph_parent( Meta_Modifier_Affect& o,
    const std::string& foreign_key_field, const std::string& init_value );
...
inline std::string to_string( const Meta_Modifier_Affect& c ) { return c.get_key( ); }

inline bool is_null( const Meta_Modifier_Affect& c ) { return c.get_key( ).empty( ); }

inline bool check_equal( const Meta_Modifier_Affect& c, const char* p ) { return c.get_key( ) == p; }
inline bool check_not_equal( const Meta_Modifier_Affect& c, const char* p ) { return !( c.get_key( ) == p ); }
