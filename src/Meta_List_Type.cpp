...
void Meta_List_Type::impl::validate(
...
void Meta_List_Type::impl::validate_set_fields(
...
void Meta_List_Type::impl::completed_fetch( bool skip_set_original )
{
...
void Meta_List_Type::validate( uint64_t state, bool is_internal )
{
...
void Meta_List_Type::completed_fetch( bool skip_set_original )
{
...
string Meta_List_Type::get_func_variable( const std::string& name ) const
{
...
const char* Meta_List_Type::static_persistence_extra( )
{
   return "";
}
