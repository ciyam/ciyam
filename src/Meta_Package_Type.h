...
#ifndef META_PACKAGE_TYPE_H
#  define META_PACKAGE_TYPE_H
...
class Meta_Package_Type : public class_base
{
   friend class Meta_Application_Script;
   friend class Meta_Package;

   public:
   typedef Meta_Package_Type class_type;
   ...
   void Dependencies( const std::string& Dependencies );
   ...
   static const char* static_class_id( ) { return "135100"; }
   static const char* static_class_name( ) { return "Package_Type"; }
   static const char* static_plural_name( ) { return "Package_Types"; }
   ...
   static void static_insert_external_alias( const std::string& module_and_class_id, Meta_Package_Type* p_instance );
   static void static_remove_external_alias( const std::string& module_and_class_id );

   private:
   Meta_Package_Type( const Meta_Package_Type& );
   Meta_Package_Type& operator =( const Meta_Package_Type& );
...
inline std::string to_string( const Meta_Package_Type& c ) { return c.get_key( ); }

inline bool is_null( const Meta_Package_Type& c ) { return c.get_key( ).empty( ); }

inline bool check_equal( const Meta_Package_Type& c, const char* p ) { return c.get_key( ) == p; }
