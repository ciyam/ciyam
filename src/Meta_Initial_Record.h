...
#ifndef META_INITIAL_RECORD_H
#  define META_INITIAL_RECORD_H
...
#     define META_INITIAL_RECORD_DECL_SPEC DYNAMIC_EXPORT
#  else
#     define META_INITIAL_RECORD_DECL_SPEC DYNAMIC_IMPORT
#  endif

class Meta_Initial_Record_Value;
class Meta_Class;

class META_INITIAL_RECORD_DECL_SPEC Meta_Initial_Record : public class_base
{
   friend class Meta_Initial_Record_Value;
   friend class Meta_Class;

   public:
   typedef Meta_Initial_Record class_type;

   enum field_id
   {
      e_field_id_none = 0,
      e_field_id_Class = 1,
      e_field_id_Comments = 2,
      e_field_id_Key = 3,
      e_field_id_Order = 4
   };
   ...
   static const char* static_class_id( ) { return "129100"; }
   static const char* static_class_name( ) { return "Initial_Record"; }
   static const char* static_plural_name( ) { return "Initial_Records"; }
   ...
   static void static_insert_external_alias( const std::string& module_and_class_id, Meta_Initial_Record* p_instance );
   static void static_remove_external_alias( const std::string& module_and_class_id );

   private:
   Meta_Initial_Record( const Meta_Initial_Record& );
   Meta_Initial_Record& operator =( const Meta_Initial_Record& );
...
inline std::string to_string( const Meta_Initial_Record& c ) { return c.get_key( ); }

inline bool is_null( const Meta_Initial_Record& c ) { return c.get_key( ).empty( ); }

inline bool check_equal( const Meta_Initial_Record& c, const char* p ) { return c.get_key( ) == p; }
