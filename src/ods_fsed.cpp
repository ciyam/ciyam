...
int main( int argc, char* argv[ ] )
{
   ...
   try
   {
      // NOTE: Use block scope for startup command processor object...
      {
         ...
         cmd_handler.add_command( c_cmd_use_sync_file_writing, 3,
          "", "use sync file writing mode", new ods_fsed_startup_functor( cmd_handler ) );

         cmd_handler.add_command( c_cmd_use_for_regression_tests, 3,
          "", "use only for regression tests", new ods_fsed_startup_functor( cmd_handler ) );
