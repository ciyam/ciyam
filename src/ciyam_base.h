...
int CIYAM_BASE_DECL_SPEC run_script( const std::string& script_name, bool async = true, bool delay = false );

std::string CIYAM_BASE_DECL_SPEC process_script_args(
 const std::string& raw_args, bool is_for_client_script = false );
