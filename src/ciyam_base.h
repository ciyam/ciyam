...
void list_sessions( std::ostream& os,
 bool inc_own = true, bool inc_dtms = true, bool include_progress = true,
 bool include_supports = true, const std::string* p_session_identifiers = 0 );
...
void add_queue_item_for_linked_sessions(
 const std::string& name, const std::string& value, size_t max_items = 0 );
