...
#ifndef META_ENUM_ITEM_H
#  define META_ENUM_ITEM_H
...
#     define META_ENUM_ITEM_DECL_SPEC DYNAMIC_EXPORT
#  else
#     define META_ENUM_ITEM_DECL_SPEC DYNAMIC_IMPORT
#  endif

class Meta_Specification;
class Meta_Enum;

class META_ENUM_ITEM_DECL_SPEC Meta_Enum_Item : public class_base
{
   friend class Meta_Specification;
   friend class Meta_Enum;

   public:
   typedef Meta_Enum_Item class_type;
   ...
   Meta_Specification& child_Specification_Enum_Item_2( );
   const Meta_Specification& child_Specification_Enum_Item_2( ) const;

   Meta_Specification& child_Specification_Enum_Item_3( );
   const Meta_Specification& child_Specification_Enum_Item_3( ) const;

   Meta_Specification& child_Specification_Enum_Item_4( );
   const Meta_Specification& child_Specification_Enum_Item_4( ) const;

   Meta_Specification& child_Specification_Enum_Item_5( );
   const Meta_Specification& child_Specification_Enum_Item_5( ) const;
   ...
   static const char* static_class_id( ) { return "104100"; }
   static const char* static_class_name( ) { return "Enum_Item"; }
   static const char* static_plural_name( ) { return "Enum_Items"; }
   ...
   static void static_insert_external_alias( const std::string& module_and_class_id, Meta_Enum_Item* p_instance );
   static void static_remove_external_alias( const std::string& module_and_class_id );

   private:
   Meta_Enum_Item( const Meta_Enum_Item& );
   Meta_Enum_Item& operator =( const Meta_Enum_Item& );
...
inline std::string to_string( const Meta_Enum_Item& c ) { return c.get_key( ); }

inline bool is_null( const Meta_Enum_Item& c ) { return c.get_key( ).empty( ); }

inline bool check_equal( const Meta_Enum_Item& c, const char* p ) { return c.get_key( ) == p; }
inline bool check_not_equal( const Meta_Enum_Item& c, const char* p ) { return !( c.get_key( ) == p ); }
