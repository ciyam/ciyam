...
string Meta_Procedure::get_func_variable( const std::string& name ) const
{
...
void Meta_Procedure::static_get_all_index_pairs( vector< pair< string, string > >& pairs )
{
   ...
   pairs.push_back( make_pair( "Source_Procedure,@pk", "string,string" ) );
}
...
void Meta_Procedure::static_get_sql_indexes( vector< string >& indexes )
{
   ...
   indexes.push_back( "C_Source_Procedure,C_Key_" );
}
