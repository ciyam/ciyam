...
#ifndef META_VIEW_FIELD_TYPE_H
#  define META_VIEW_FIELD_TYPE_H
...
#     define META_VIEW_FIELD_TYPE_DECL_SPEC DYNAMIC_EXPORT
#  else
#     define META_VIEW_FIELD_TYPE_DECL_SPEC DYNAMIC_IMPORT
#  endif

class Meta_View_Field;

class META_VIEW_FIELD_TYPE_DECL_SPEC Meta_View_Field_Type : public class_base
{
   friend class Meta_View_Field;

   public:
   typedef Meta_View_Field_Type class_type;

   enum field_id
   {
      e_field_id_none = 0,
      e_field_id_Name = 1,
      e_field_id_View_Field_Name = 2
   };

   Meta_View_Field_Type( );
   ~Meta_View_Field_Type( );

   const std::string& Name( ) const;
   void Name( const std::string& Name );

   const std::string& View_Field_Name( ) const;
   void View_Field_Name( const std::string& View_Field_Name );

   Meta_View_Field& child_View_Field_Type( );
   const Meta_View_Field& child_View_Field_Type( ) const;
   ...
   static const char* static_class_id( ) { return "119100"; }
   static const char* static_class_name( ) { return "View_Field_Type"; }
   static const char* static_plural_name( ) { return "View_Field_Types"; }
   ...
   static void static_insert_external_alias( const std::string& module_and_class_id, Meta_View_Field_Type* p_instance );
   static void static_remove_external_alias( const std::string& module_and_class_id );

   private:
   Meta_View_Field_Type( const Meta_View_Field_Type& );
   Meta_View_Field_Type& operator =( const Meta_View_Field_Type& );
...
inline std::string to_string( const Meta_View_Field_Type& c ) { return c.get_key( ); }

inline bool is_null( const Meta_View_Field_Type& c ) { return c.get_key( ).empty( ); }

inline bool check_equal( const Meta_View_Field_Type& c, const char* p ) { return c.get_key( ) == p; }
