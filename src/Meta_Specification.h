...
class META_SPECIFICATION_DECL_SPEC Meta_Specification : public class_base
{
   ...
   enum field_id
   {
      ...
      e_field_id_Other_Class_Field = 29,
      e_field_id_Other_Field = 30,
      e_field_id_Other_Field_2 = 31,
      e_field_id_Other_Modifier = 32,
      e_field_id_Other_Modifier_2 = 33,
      e_field_id_Other_Permission = 34,
      e_field_id_Other_Permission_2 = 35,
      e_field_id_Other_Procedure = 36,
      e_field_id_Other_Procedure_2 = 37,
      e_field_id_Other_Source_Child = 38,
      e_field_id_Other_Source_Child_2 = 39,
      e_field_id_Parent_Specification = 40,
      e_field_id_Permission = 41,
      e_field_id_Procedure = 42,
      e_field_id_Procedure_Arg = 43,
      e_field_id_Procedure_Arg_2 = 44,
      e_field_id_Procedure_Arg_3 = 45,
      e_field_id_Protect_Child_Rel = 46,
      e_field_id_Protect_Procedure = 47,
      e_field_id_Protect_Source_Parent = 48,
      e_field_id_Restrict_Values = 49,
      e_field_id_Source_Child = 50,
      e_field_id_Source_Child_Class = 51,
      e_field_id_Source_Class = 52,
      e_field_id_Source_Field = 53,
      e_field_id_Source_Field_Class = 54,
      e_field_id_Source_Grandchild = 55,
      e_field_id_Source_Parent = 56,
      e_field_id_Source_Parent_Class = 57,
      e_field_id_Specification_Type = 58,
      e_field_id_Strings = 59,
      e_field_id_Test_Child = 60,
      e_field_id_Test_Field = 61,
      e_field_id_Test_Field_Class = 62,
      e_field_id_Test_Parent = 63,
      e_field_id_Test_Parent_Class = 64,
      e_field_id_Test_Value = 65,
      e_field_id_Test_Value_Label = 66,
      e_field_id_Use_Source_Parent = 67,
      e_field_id_Use_Test_Parent_Child = 68,
      e_field_id_Value = 69,
      e_field_id_Value_Label = 70,
      e_field_id_Value_Left_Part = 71,
      e_field_id_Value_Literal = 72,
      e_field_id_Value_Numeric_String = 73,
      e_field_id_Value_Right_Part = 74,
      e_field_id_Value_String = 75,
      e_field_id_Vars = 76
   };
