...
void Meta_Model::impl::validate( unsigned state, bool is_internal, validation_error_container* p_validation_errors )
{
   ...
   if( !is_null( v_Home_Title )
    ...
    && !g_Home_Title_domain.is_valid( v_Home_Title, error_message = "" ) )
      p_validation_errors->insert( validation_error_value_type( c_field_name_Home_Title,
...
void Meta_Model::impl::finalise_fetch( bool skip_set_original )
{
...
void Meta_Model::finalise_fetch( bool skip_set_original )
{
...
string Meta_Model::get_field_uom_symbol( const string& id_or_name ) const
{
   ...
   else if( id_or_name == c_field_id_Home_Title || id_or_name == c_field_name_Home_Title )
   {
