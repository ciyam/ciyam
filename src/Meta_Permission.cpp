...
void Meta_Permission::impl::completed_fetch( bool skip_set_original )
{
...
void Meta_Permission::completed_fetch( bool skip_set_original )
{
...
string Meta_Permission::get_func_variable( const std::string& name ) const
{
