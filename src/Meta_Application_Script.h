...
class Meta_Application_Script : public class_base
{
   ...
   const std::string& Other_Package_Types( ) const;
   void Other_Package_Types( const std::string& Other_Package_Types );
