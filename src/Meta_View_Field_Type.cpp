...
void Meta_View_Field_Type_command_functor::operator ( )( const string& command, const parameter_info& parameters )
{
   ...
   {
      bool want_fixed( has_parm_val( parameters, c_cmd_Meta_View_Field_Type_key_fixed ) );
   ...
   {
      string field_name( get_parm_val( parameters, c_cmd_Meta_View_Field_Type_get_field_name ) );
      ...
      if( !handled && ( ( field_name == c_field_id_View_Field_Name ) || ( field_name == c_field_name_View_Field_Name ) ) )
      {
         handled = true;
   ...
   {
      string field_name( get_parm_val( parameters, c_cmd_Meta_View_Field_Type_set_field_name ) );
      string field_value( get_parm_val( parameters, c_cmd_Meta_View_Field_Type_set_field_value ) );
   ...
   {
      string field_name( get_parm_val( parameters, c_cmd_Meta_View_Field_Type_cmd_field_name ) );
      string cmd_and_args( get_parm_val( parameters, c_cmd_Meta_View_Field_Type_cmd_cmd_and_args ) );
...
void Meta_View_Field_Type::impl::set_field_default( int field )
{
   switch( field )
   {
      case 0:
      ...
      case 1:
      impl_View_Field_Name( g_default_View_Field_Name );
      break;
...
bool Meta_View_Field_Type::impl::is_field_default( int field ) const
{
   bool retval = false;
   ...
   switch( field )
   {
      ...
      case 1:
      retval = ( v_View_Field_Name == g_default_View_Field_Name );
      break;
...
string Meta_View_Field_Type::impl::get_state_names( ) const
{
   string state_names;
...
void Meta_View_Field_Type::impl::add_extra_fixed_info( vector< pair< string, string > >& fixed_info ) const
{
   ( void )fixed_info;
...
void Meta_View_Field_Type::impl::validate(
 uint64_t state, bool is_internal, validation_error_container* p_validation_errors )
{
   ...
   if( is_null( v_View_Field_Name ) && !value_will_be_provided( c_field_name_View_Field_Name ) )
      p_validation_errors->insert( construct_validation_error( vf.num, c_field_name_View_Field_Name,
       get_string_message( GS( c_str_field_must_not_be_empty ), make_pair(
       c_str_field_must_not_be_empty_field, get_module_string( c_field_display_name_View_Field_Name ) ) ) ) );
...
void Meta_View_Field_Type::impl::validate_set_fields(
...
void Meta_View_Field_Type::impl::completed_fetch( bool skip_set_original )
{
...
void Meta_View_Field_Type::set_field_default( int field )
{
   return set_field_default( ( field_id )( field + 1 ) );
}

void Meta_View_Field_Type::set_field_default( field_id id )
{
   p_impl->set_field_default( ( int )id - 1 );
}

void Meta_View_Field_Type::set_field_default( const string& field )
{
   p_impl->set_field_default( get_field_num( field ) );
}

bool Meta_View_Field_Type::is_field_default( int field ) const
{
   return is_field_default( ( field_id )( field + 1 ) );
}

bool Meta_View_Field_Type::is_field_default( field_id id ) const
{
   return p_impl->is_field_default( ( int )id - 1 );
}

bool Meta_View_Field_Type::is_field_default( const string& field ) const
{
   return p_impl->is_field_default( get_field_num( field ) );
}

bool Meta_View_Field_Type::is_field_encrypted( int field ) const
{
...
string Meta_View_Field_Type::get_field_id( int field ) const
{
...
void Meta_View_Field_Type::validate( uint64_t state, bool is_internal )
{
...
void Meta_View_Field_Type::completed_fetch( bool skip_set_original )
{
...
string& Meta_View_Field_Type::get_owner_field_name( ) const
{
   return g_owner_field_name;
}

bool Meta_View_Field_Type::is_file_field( const string& id_or_name ) const
{
...
string Meta_View_Field_Type::get_field_uom_symbol( const string& id_or_name ) const
{
   ...
   if( ( id_or_name == c_field_id_View_Field_Name ) || ( id_or_name == c_field_name_View_Field_Name ) )
   {
...
void Meta_View_Field_Type::add_extra_fixed_info( vector< pair< string, string > >& fixed_info ) const
{
...
string Meta_View_Field_Type::get_class_id( ) const
{
   return static_class_id( );
}

string Meta_View_Field_Type::get_class_name( ) const
{
   return static_class_name( );
}

string Meta_View_Field_Type::get_plural_name( ) const
{
   return static_plural_name( );
}

string Meta_View_Field_Type::get_module_id( ) const
{
   return static_module_id( );
}

string Meta_View_Field_Type::get_module_name( ) const
{
...
string Meta_View_Field_Type::get_func_variable( const std::string& name ) const
{
...
string Meta_View_Field_Type::get_create_instance_info( ) const
{
   return "";
}

string Meta_View_Field_Type::get_update_instance_info( ) const
{
   return "";
}

string Meta_View_Field_Type::get_destroy_instance_info( ) const
{
   return "";
}

string Meta_View_Field_Type::get_execute_procedure_info( const string& procedure_id ) const
{
   string retval;
...
void Meta_View_Field_Type::do_generate_sql( generate_sql_type type,
...
bool Meta_View_Field_Type::static_is_field_encrypted( field_id id )
{
