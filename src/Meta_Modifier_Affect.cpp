...
void Meta_Modifier_Affect::impl::completed_fetch( bool skip_set_original )
{
...
void Meta_Modifier_Affect::completed_fetch( bool skip_set_original )
{
...
string Meta_Modifier_Affect::get_func_variable( const std::string& name ) const
{
...
{
   pairs.push_back( make_pair( "Class,@pk", "string,string" ) );
   pairs.push_back( make_pair( "Field,@pk", "string,string" ) );
   pairs.push_back( make_pair( "Modifier,@pk", "string,string" ) );
   pairs.push_back( make_pair( "Source_Modifier_Affect,@pk", "string,string" ) );
}
...
{
   indexes.push_back( "C_Class,C_Key_" );
   indexes.push_back( "C_Field,C_Key_" );
   indexes.push_back( "C_Modifier,C_Key_" );
   indexes.push_back( "C_Source_Modifier_Affect,C_Key_" );
}
