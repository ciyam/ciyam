...
void Meta_Module::impl::completed_fetch( bool skip_set_original )
{
...
void Meta_Module::completed_fetch( bool skip_set_original )
{
...
string Meta_Module::get_func_variable( const std::string& name ) const
{
