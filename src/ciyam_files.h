// Copyright (c) 2013-2023 CIYAM Developers
//
...
void CIYAM_BASE_DECL_SPEC remove_file_archive(
 const std::string& name, bool destroy_files = false, bool remove_directory = false, progress* p_progress = 0 );
...
size_t CIYAM_BASE_DECL_SPEC remove_all_repository_entries( const std::string& repository,
 date_time* p_dtm, progress* p_progress = 0, size_t num_seconds = 1, bool set_session_progress = false );
