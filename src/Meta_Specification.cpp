 ...
 uint64_t state, bool is_internal, validation_error_container* p_validation_errors )
{
   ...
   if( v_Specification_Type.empty( ) && !value_will_be_provided( c_field_name_Specification_Type ) )
      p_validation_errors->insert( construct_validation_error( vf.num, c_field_name_Specification_Type,
       get_string_message( GS( c_str_field_must_not_be_empty ), make_pair(
       c_str_field_must_not_be_empty_field, get_module_string( c_field_display_name_Specification_Type ) ) ) ) );
   ...
   if( get_obj( ).Specification_Type( ).Needs_Other_Class( ) && is_null( get_obj( ).Other_Class( ) ) )
      p_validation_errors->insert( construct_validation_error( vf.num,
       ...
       c_str_field_must_not_be_empty_field, get_module_string( c_field_display_name_Other_Class ) ) ) ) );
   ...
   if( get_obj( ).Specification_Type( ).Needs_Procedure( ) && is_null( get_obj( ).Procedure( ) ) )
      p_validation_errors->insert( construct_validation_error( vf.num,
       ...
       c_str_field_must_not_be_empty_field, get_module_string( c_field_display_name_Procedure ) ) ) ) );
   ...
   if( get_obj( ).Specification_Type( ).Needs_Procedure_Arg( ) && is_null( get_obj( ).Procedure_Arg( ) ) )
      p_validation_errors->insert( construct_validation_error( vf.num,
       ...
       c_str_field_must_not_be_empty_field, get_module_string( c_field_display_name_Procedure_Arg ) ) ) ) );
   ...
   if( get_obj( ).Specification_Type( ).Needs_Procedure_Arg_2( ) && is_null( get_obj( ).Procedure_Arg_2( ) ) )
      p_validation_errors->insert( construct_validation_error( vf.num,
       ...
       c_str_field_must_not_be_empty_field, get_module_string( c_field_display_name_Procedure_Arg_2 ) ) ) ) );
   ...
   if( get_obj( ).Specification_Type( ).Needs_Procedure_Arg_3( ) && is_null( get_obj( ).Procedure_Arg_3( ) ) )
      p_validation_errors->insert( construct_validation_error( vf.num,
       ...
       c_str_field_must_not_be_empty_field, get_module_string( c_field_display_name_Procedure_Arg_3 ) ) ) ) );
   ...
   if( get_obj( ).Specification_Type( ).Needs_Other_Procedure( ) && is_null( get_obj( ).Other_Procedure( ) ) )
      p_validation_errors->insert( construct_validation_error( vf.num,
       ...
       c_str_field_must_not_be_empty_field, get_module_string( c_field_display_name_Other_Procedure ) ) ) ) );
   ...
   if( get_obj( ).Specification_Type( ).Needs_Other_Procedure_2( ) && is_null( get_obj( ).Other_Procedure_2( ) ) )
      p_validation_errors->insert( construct_validation_error( vf.num,
       ...
       c_str_field_must_not_be_empty_field, get_module_string( c_field_display_name_Other_Procedure_2 ) ) ) ) );
   ...
   if( get_obj( ).Specification_Type( ).Needs_Other_Modifier( ) && is_null( get_obj( ).Other_Modifier( ) ) )
      p_validation_errors->insert( construct_validation_error( vf.num,
       ...
       c_str_field_must_not_be_empty_field, get_module_string( c_field_display_name_Other_Modifier ) ) ) ) );
   ...
   if( get_obj( ).Specification_Type( ).Needs_Other_Modifier_2( ) && is_null( get_obj( ).Other_Modifier_2( ) ) )
      p_validation_errors->insert( construct_validation_error( vf.num,
       ...
       c_str_field_must_not_be_empty_field, get_module_string( c_field_display_name_Other_Modifier_2 ) ) ) ) );
   ...
   if( get_obj( ).Specification_Type( ).Needs_Enum_Item( ) && is_null( get_obj( ).Enum_Item( ) ) )
      p_validation_errors->insert( construct_validation_error( vf.num,
       ...
       c_str_field_must_not_be_empty_field, get_module_string( c_field_display_name_Enum_Item ) ) ) ) );
   ...
   if( get_obj( ).Specification_Type( ).Needs_Enum_Item_2( ) && is_null( get_obj( ).Enum_Item_2( ) ) )
      p_validation_errors->insert( construct_validation_error( vf.num,
       ...
       c_str_field_must_not_be_empty_field, get_module_string( c_field_display_name_Enum_Item_2 ) ) ) ) );
   ...
   if( get_obj( ).Specification_Type( ).Needs_Enum_Item_3( ) && is_null( get_obj( ).Enum_Item_3( ) ) )
      p_validation_errors->insert( construct_validation_error( vf.num,
       ...
       c_str_field_must_not_be_empty_field, get_module_string( c_field_display_name_Enum_Item_3 ) ) ) ) );
   ...
   if( get_obj( ).Specification_Type( ).Needs_Enum_Item_4( ) && is_null( get_obj( ).Enum_Item_4( ) ) )
      p_validation_errors->insert( construct_validation_error( vf.num,
       ...
       c_str_field_must_not_be_empty_field, get_module_string( c_field_display_name_Enum_Item_4 ) ) ) ) );
   ...
   if( get_obj( ).Specification_Type( ).Needs_Enum_Item_5( ) && is_null( get_obj( ).Enum_Item_5( ) ) )
      p_validation_errors->insert( construct_validation_error( vf.num,
       ...
       c_str_field_must_not_be_empty_field, get_module_string( c_field_display_name_Enum_Item_5 ) ) ) ) );
   ...
   if( get_obj( ).Specification_Type( ).Needs_Source_Parent( ) && is_null( get_obj( ).Source_Parent( ) ) )
      p_validation_errors->insert( construct_validation_error( vf.num,
       ...
       c_str_field_must_not_be_empty_field, get_module_string( c_field_display_name_Source_Parent ) ) ) ) );
   ...
   if( get_obj( ).Specification_Type( ).Needs_Source_Field( ) && is_null( get_obj( ).Source_Field( ) ) )
      p_validation_errors->insert( construct_validation_error( vf.num,
       ...
       c_str_field_must_not_be_empty_field, get_module_string( c_field_display_name_Source_Field ) ) ) ) );
   ...
   if( get_obj( ).Specification_Type( ).Needs_Test_Field( ) && !get_obj( ).Use_Test_Parent_Child( ) && is_null( get_obj( ).Test_Field( ) ) )
      p_validation_errors->insert( construct_validation_error( vf.num,
       ...
       c_str_field_must_not_be_empty_field, get_module_string( c_field_display_name_Test_Field ) ) ) ) );
   ...
   if( get_obj( ).Specification_Type( ).Needs_Test_Field( ) && get_obj( ).Use_Test_Parent_Child( ) && is_null( get_obj( ).Test_Child( ) ) )
      p_validation_errors->insert( construct_validation_error( vf.num,
       ...
       c_str_field_must_not_be_empty_field, get_module_string( c_field_display_name_Test_Child ) ) ) ) );
   ...
   if( get_obj( ).Specification_Type( ).Needs_Test_Value( ) && is_null( get_obj( ).Test_Value( ) ) )
      p_validation_errors->insert( construct_validation_error( vf.num,
       ...
       c_str_field_must_not_be_empty_field, get_module_string( c_field_display_name_Test_Value ) ) ) ) );
   ...
   if( get_obj( ).Specification_Type( ).Needs_Source_Child( ) && is_null( get_obj( ).Source_Child( ) ) )
      p_validation_errors->insert( construct_validation_error( vf.num,
       ...
       c_str_field_must_not_be_empty_field, get_module_string( c_field_display_name_Source_Child ) ) ) ) );
   ...
   if( get_obj( ).Specification_Type( ).Needs_Child_Relationship( ) && is_null( get_obj( ).Child_Relationship( ) ) )
      p_validation_errors->insert( construct_validation_error( vf.num,
       ...
       c_str_field_must_not_be_empty_field, get_module_string( c_field_display_name_Child_Relationship ) ) ) ) );
   ...
   // NOTE: Scope for local variables.
   {
      ...
      {
         p_validation_errors->insert( construct_validation_error( vf.num, "",
          get_string_message( GS( c_str_error ), make_pair( c_str_error_error, error ) ) ) );
      }
      ...
      if( get_obj( ).Specification_Type( ).Test_Field_Type_Match( ) && get_obj( ).Field( ).Primitive( ) != test_primitive )
         p_validation_errors->insert( construct_validation_error( vf.num, "",
          ...
          c_str_field_types_must_match_field1, get_module_string( c_field_display_name_Field ) ),
          make_pair( c_str_field_types_must_match_field2, get_module_string( c_field_display_name_Test_Field ) ) ) ) );

      if( get_obj( ).Specification_Type( ).Source_Field_Type_Match( ) && get_obj( ).Field( ).Primitive( ) != source_primitive )
         p_validation_errors->insert( construct_validation_error( vf.num, "",
          get_string_message( GS( c_str_field_types_must_match ), make_pair(
          c_str_field_types_must_match_field1, get_module_string( c_field_display_name_Field ) ),
          make_pair( c_str_field_types_must_match_field2, get_module_string( c_field_display_name_Source_Field ) ) ) ) );
      ...
      if( get_obj( ).Specification_Type( ).Source_Field_Needs_Test_Field( )
       && get_obj( ).Test_Field( ).get_key( ).empty( ) && !get_obj( ).Source_Field( ).get_key( ).empty( ) )
         p_validation_errors->insert( construct_validation_error( vf.num, "",
          ...
          c_str_field_must_be_empty_match_field2, get_module_string( c_field_display_name_Source_Field ) ),
          make_pair( c_str_field_must_be_empty_match_field1, get_module_string( c_field_display_name_Test_Field ) ) ) ) );
   ...
   if( is_null( get_obj( ).Test_Child( ) ) && !is_null( get_obj( ).Test_Parent( ) ) )
      p_validation_errors->insert( construct_validation_error( vf.num,
       ...
       c_str_field_must_be_empty_match_field2, get_module_string( c_field_display_name_Test_Parent ) ),
       make_pair( c_str_field_must_be_empty_match_field1, get_module_string( c_field_display_name_Test_Child ) ) ) ) );
   ...
   if( get_obj( ).Specification_Type( ).Needs_Other_Field( ) && is_null( get_obj( ).Other_Field( ) ) )
      p_validation_errors->insert( construct_validation_error( vf.num,
       ...
       c_str_field_must_not_be_empty_field, get_module_string( c_field_display_name_Other_Field ) ) ) ) );
   ...
   if( get_obj( ).Specification_Type( ).Needs_Other_Source_Child( ) && is_null( get_obj( ).Other_Source_Child( ) ) )
      p_validation_errors->insert( construct_validation_error( vf.num,
       ...
       c_str_field_must_not_be_empty_field, get_module_string( c_field_display_name_Other_Source_Child ) ) ) ) );
   ...
   if( get_obj( ).Specification_Type( ).Needs_Permission( ) && is_null( get_obj( ).Permission( ) ) )
      p_validation_errors->insert( construct_validation_error( vf.num,
       ...
       c_str_field_must_not_be_empty_field, get_module_string( c_field_display_name_Permission ) ) ) ) );
   ...
   if( get_obj( ).Specification_Type( ).Needs_Other_Field_2( ) && is_null( get_obj( ).Other_Field_2( ) ) )
      p_validation_errors->insert( construct_validation_error( vf.num,
       ...
       c_str_field_must_not_be_empty_field, get_module_string( c_field_display_name_Other_Field_2 ) ) ) ) );
   ...
   if( get_obj( ).Specification_Type( ).Needs_Other_Source_Child_2( ) && is_null( get_obj( ).Other_Source_Child_2( ) ) )
      p_validation_errors->insert( construct_validation_error( vf.num,
       ...
       c_str_field_must_not_be_empty_field, get_module_string( c_field_display_name_Other_Source_Child_2 ) ) ) ) );
   ...
   if( get_obj( ).Specification_Type( ).Needs_Other_Class_Field( ) && is_null( get_obj( ).Other_Class_Field( ) ) )
      p_validation_errors->insert( construct_validation_error( vf.num,
       ...
       c_str_field_must_not_be_empty_field, get_module_string( c_field_display_name_Other_Class_Field ) ) ) ) );
...
void Meta_Specification::impl::completed_fetch( bool skip_set_original )
{
...
void Meta_Specification::completed_fetch( bool skip_set_original )
{
