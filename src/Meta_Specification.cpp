...
string Meta_Specification::get_field_uom_symbol( const string& id_or_name ) const
{
   ...
   else if( id_or_name == c_field_id_Other_Source_Child || id_or_name == c_field_name_Other_Source_Child )
   {
      name = string( c_field_display_name_Other_Source_Child );
      get_module_string( c_field_display_name_Other_Source_Child, &next );
   }
   else if( id_or_name == c_field_id_Other_Source_Child_2 || id_or_name == c_field_name_Other_Source_Child_2 )
   {
...
string Meta_Specification::static_get_sql_columns( )
{
   ...
   sql_columns += 
    ...
    "C_Other_Class VARCHAR(75) NOT NULL,"
    "C_Other_Field VARCHAR(75) NOT NULL,"
    "C_Other_Field_2 VARCHAR(75) NOT NULL,"
    "C_Other_Modifier VARCHAR(75) NOT NULL,"
    "C_Other_Modifier_2 VARCHAR(75) NOT NULL,"
    "C_Other_Permission VARCHAR(75) NOT NULL,"
    "C_Other_Permission_2 VARCHAR(75) NOT NULL,"
    "C_Other_Procedure VARCHAR(75) NOT NULL,"
    "C_Other_Procedure_2 VARCHAR(75) NOT NULL,"
    "C_Other_Source_Child VARCHAR(75) NOT NULL,"
    "C_Other_Source_Child_2 VARCHAR(75) NOT NULL,"
    "C_Parent_Specification VARCHAR(75) NOT NULL,"
    "C_Permission VARCHAR(75) NOT NULL,"
    "C_Procedure VARCHAR(75) NOT NULL,"
    "C_Procedure_Arg VARCHAR(75) NOT NULL,"
    "C_Procedure_Arg_2 VARCHAR(75) NOT NULL,"
    "C_Procedure_Arg_3 VARCHAR(75) NOT NULL,"
    ...
    "C_Source_Field_Class VARCHAR(75) NOT NULL,"
    "C_Source_Grandchild VARCHAR(75) NOT NULL,"
    "C_Source_Parent VARCHAR(75) NOT NULL,"
    "C_Source_Parent_Class VARCHAR(75) NOT NULL,"
    "C_Specification_Type VARCHAR(75) NOT NULL,"
    "C_Test_Child VARCHAR(75) NOT NULL,"
    "C_Test_Field VARCHAR(75) NOT NULL,"
    "C_Test_Field_Class VARCHAR(75) NOT NULL,"
    "C_Test_Parent VARCHAR(75) NOT NULL,"
    "C_Test_Parent_Class VARCHAR(75) NOT NULL,"
