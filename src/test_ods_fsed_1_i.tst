...
/def> folder_move test_3 test_1/test_2
...
Item #6, data = /def/test_1/test_2, link = -1
Item #7, data = /def/test_1/test_2/test_3, link = -1
...
Item #24, data = :def:test_1/test_2, link = -1
Item #25, data = :def:test_1:test_2/test_3, link = -1
