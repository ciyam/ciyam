...
bool Meta_Relationship::impl::is_filtered( const set< string >& filters ) const
{
   ( void )filters;
...
bool Meta_Relationship::is_filtered( const set< string >& filters ) const
{
...
string Meta_Relationship::get_field_display_name( const string& id ) const
{
   string display_name;
...
string Meta_Relationship::static_get_sql_columns( )
{
   ...
   sql_columns += 
    ...
    "C_Field_Id VARCHAR(128) NOT NULL,"
    "C_Field_Key VARCHAR(128) NOT NULL,"
