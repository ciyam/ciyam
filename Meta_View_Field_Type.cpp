...
bool Meta_View_Field_Type::impl::is_filtered( const set< string >& filters ) const
{
   ( void )filters;
...
bool Meta_View_Field_Type::is_filtered( const set< string >& filters ) const
{
...
string Meta_View_Field_Type::get_field_display_name( const string& id ) const
{
   string display_name;
...
string Meta_View_Field_Type::static_get_sql_columns( )
{
   ...
   sql_columns += 
    ...
    "C_View_Field_Name VARCHAR(128) NOT NULL,"
    "PRIMARY KEY(C_Key_)";
