...
void Meta_List_Type::impl::do_post_init( )
{
   // [<start do_post_init>]
   // [<finish do_post_init>]
}
...
void Meta_List_Type::do_post_init( )
{
   p_impl->do_post_init( );
}
...
void Meta_List_Type::do_generate_sql( generate_sql_type type, vector< string >& sql_stmts ) const
{
