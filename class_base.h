...
class CLASS_BASE_DECL_SPEC class_base
{
   ...
   virtual std::string get_field_display_name( const std::string& id ) const = 0;
...
std::string CLASS_BASE_DECL_SPEC escaped_string( const std::string& s, const std::string& escape_chars, char esc = '\\' );
...
std::string CLASS_BASE_DECL_SPEC meta_field_extras( int uom, int extra, int max_size,
