...
std::string CIYAM_BASE_DECL_SPEC encrypt_password( const std::string& password, bool no_salt = false );
std::string CIYAM_BASE_DECL_SPEC decrypt_password( const std::string& password, bool no_salt = false );
