...
string Meta_Application::get_field_display_name( const string& id ) const
{
   string display_name;
 ...
 set< string >& names, bool required_transients, set< string >& dependents ) const
{
   ...
   if( ( required_transients && is_field_transient( e_field_id_Generate_Type ) )
    || ( !required_transients && !is_field_transient( e_field_id_Generate_Type ) ) )
...
string Meta_Application::static_get_sql_columns( )
{
   ...
   sql_columns += 
    ...
    "C_Default_Timezone_Abbr VARCHAR(128) NOT NULL,"
    "C_Generate_Status VARCHAR(128) NOT NULL,"
    "C_Generate_Type INTEGER NOT NULL,"
    "C_Keep_Existing_Data INTEGER NOT NULL,"
    "C_Module_Prefix VARCHAR(128) NOT NULL,"
