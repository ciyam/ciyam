...
bool Meta_Field::impl::is_filtered( const set< string >& filters ) const
{
   ( void )filters;
...
bool Meta_Field::is_filtered( const set< string >& filters ) const
{
...
string Meta_Field::get_field_display_name( const string& id ) const
{
   string display_name;
