...
class cat_session_command_functor : public command_functor
{
   public:
   cat_session_command_functor( command_handler& handler )
...
command_functor* cat_session_command_functor_factory( const string& /*name*/, command_handler& handler )
{
   return new cat_session_command_functor( handler );
}

void cat_session_command_functor::operator ( )( const string& command, const parameter_info& parameters )
{
#ifdef DEBUG
   ...
   try
   {
      ...
      if( command == c_cmd_cat_session_license )
         response = get_license( true, true );
      else if( command == c_cmd_cat_session_module_list )
      {
         module_list( osstr );
         output_response_lines( socket, osstr.str( ) );
      }
      else if( command == c_cmd_cat_session_module_load )
      {
         string module( get_parm_val( parameters, c_cmd_parm_cat_session_module_load_module ) );

         module_load( module, "", handler, true );
      }
      else if( command == c_cmd_cat_session_module_unload )
      {
         string module( get_parm_val( parameters, c_cmd_parm_cat_session_module_unload_module ) );

         module_unload( module, handler, true );
      }
      else if( command == c_cmd_cat_session_module_class_list )
      {
         string module( get_parm_val( parameters, c_cmd_parm_cat_session_module_class_list_module ) );

         module_class_list( module, osstr );
         output_response_lines( socket, osstr.str( ) );
      }
      else if( command == c_cmd_cat_session_module_strings_list )
      {
         string module( get_parm_val( parameters, c_cmd_parm_cat_session_module_strings_list_module ) );

         module_strings_list( module, osstr );
         output_response_lines( socket, osstr.str( ) );
      }
      else if( command == c_cmd_cat_session_module_class_field_list )
      {
         string module( get_parm_val( parameters, c_cmd_parm_cat_session_module_class_field_list_module ) );
         string class_id_or_name( get_parm_val( parameters, c_cmd_parm_cat_session_module_class_field_list_class ) );

         module_class_fields_list( module, class_id_or_name, osstr );
         output_response_lines( socket, osstr.str( ) );
      }
      else if( command == c_cmd_cat_session_object_list )
      {
         list_object_instances( osstr );
         output_response_lines( socket, osstr.str( ) );
      }
      else if( command == c_cmd_cat_session_object_fetch )
      {
         string handle( get_parm_val( parameters, c_cmd_parm_cat_session_object_fetch_handle ) );
         string context( get_parm_val( parameters, c_cmd_parm_cat_session_object_fetch_context ) );
         string key( get_parm_val( parameters, c_cmd_parm_cat_session_object_fetch_key ) );

         instance_fetch( atoi( handle.c_str( ) ), context, key );
      }
      else if( command == c_cmd_cat_session_object_create )
      {
         string module( get_parm_val( parameters, c_cmd_parm_cat_session_object_create_module ) );
         string mclass( get_parm_val( parameters, c_cmd_parm_cat_session_object_create_mclass ) );
         string handle( get_parm_val( parameters, c_cmd_parm_cat_session_object_create_handle ) );
         bool dynamic( has_parm_val( parameters, c_cmd_parm_cat_session_object_create_dynamic ) );
      ...
      else if( command == c_cmd_cat_session_object_destroy )
      {
         string handle( get_parm_val( parameters, c_cmd_parm_cat_session_object_destroy_handle ) );

         destroy_object_instance( atoi( handle.c_str( ) ) );
      }
      else if( command == c_cmd_cat_session_object_execute )
      {
         string handle( get_parm_val( parameters, c_cmd_parm_cat_session_object_execute_handle ) );
         string context( get_parm_val( parameters, c_cmd_parm_cat_session_object_execute_context ) );
         string method_name_and_args( get_parm_val( parameters, c_cmd_parm_cat_session_object_execute_method_name ) );

         if( has_parm_val( parameters, c_cmd_parm_cat_session_object_execute_args ) )
         {
            method_name_and_args += ' ';
            method_name_and_args += get_parm_val( parameters, c_cmd_parm_cat_session_object_execute_args );
         }

         response = execute_object_command( atoi( handle.c_str( ) ), context, method_name_and_args );
      }
      else if( command == c_cmd_cat_session_object_validate )
      {
         string handle( get_parm_val( parameters, c_cmd_parm_cat_session_object_validate_handle ) );
         string context( get_parm_val( parameters, c_cmd_parm_cat_session_object_validate_context ) );

         validate_object_instance( atoi( handle.c_str( ) ), context );
      }
      else if( command == c_cmd_cat_session_object_variable )
      {
         string handle( get_parm_val( parameters, c_cmd_parm_cat_session_object_variable_handle ) );
         string context( get_parm_val( parameters, c_cmd_parm_cat_session_object_variable_context ) );
         string var_name( get_parm_val( parameters, c_cmd_parm_cat_session_object_variable_var_name ) );
         bool has_new_val( has_parm_val( parameters, c_cmd_parm_cat_session_object_variable_new_value ) );
         string new_value( get_parm_val( parameters, c_cmd_parm_cat_session_object_variable_new_value ) );
      ...
      else if( command == c_cmd_cat_session_object_op_create )
      {
         string handle( get_parm_val( parameters, c_cmd_parm_cat_session_object_op_create_handle ) );
         string context( get_parm_val( parameters, c_cmd_parm_cat_session_object_op_create_context ) );
         string key( get_parm_val( parameters, c_cmd_parm_cat_session_object_op_create_key ) );

         op_instance_create( atoi( handle.c_str( ) ), context, key );
      }
      else if( command == c_cmd_cat_session_object_op_update )
      {
         string handle( get_parm_val( parameters, c_cmd_parm_cat_session_object_op_update_handle ) );
         string context( get_parm_val( parameters, c_cmd_parm_cat_session_object_op_update_context ) );
         string key( get_parm_val( parameters, c_cmd_parm_cat_session_object_op_update_key ) );
         string ver_info( get_parm_val( parameters, c_cmd_parm_cat_session_object_op_update_ver_info ) );

         op_instance_update( atoi( handle.c_str( ) ), context, key, ver_info );
      }
      else if( command == c_cmd_cat_session_object_op_destroy )
      {
         string handle( get_parm_val( parameters, c_cmd_parm_cat_session_object_op_destroy_handle ) );
         string context( get_parm_val( parameters, c_cmd_parm_cat_session_object_op_destroy_context ) );
         string key( get_parm_val( parameters, c_cmd_parm_cat_session_object_op_destroy_key ) );
         string ver_info( get_parm_val( parameters, c_cmd_parm_cat_session_object_op_destroy_ver_info ) );

         op_instance_destroy( atoi( handle.c_str( ) ), context, key, ver_info );
      }
      else if( command == c_cmd_cat_session_object_op_apply )
      {
         string handle( get_parm_val( parameters, c_cmd_parm_cat_session_object_op_apply_handle ) );
         string context( get_parm_val( parameters, c_cmd_parm_cat_session_object_op_apply_context ) );

         op_instance_apply( atoi( handle.c_str( ) ), context );
      }
      else if( command == c_cmd_cat_session_object_op_cancel )
      {
         string handle( get_parm_val( parameters, c_cmd_parm_cat_session_object_op_cancel_handle ) );
         string context( get_parm_val( parameters, c_cmd_parm_cat_session_object_op_cancel_context ) );

         op_instance_cancel( atoi( handle.c_str( ) ), context );
      }
      else if( command == c_cmd_cat_session_object_review_begin )
      {
         string handle( get_parm_val( parameters, c_cmd_parm_cat_session_object_review_begin_handle ) );
         string context( get_parm_val( parameters, c_cmd_parm_cat_session_object_review_begin_context ) );
         string key( get_parm_val( parameters, c_cmd_parm_cat_session_object_review_begin_key ) );

         instance_review_begin( atoi( handle.c_str( ) ), context, key );
      }
      else if( command == c_cmd_cat_session_object_review_finish )
      {
         string handle( get_parm_val( parameters, c_cmd_parm_cat_session_object_review_finish_handle ) );
         string context( get_parm_val( parameters, c_cmd_parm_cat_session_object_review_finish_context ) );

         instance_review_finish( atoi( handle.c_str( ) ), context );
      }
      else if( command == c_cmd_cat_session_object_iterate_forwards )
      {
         string handle( get_parm_val( parameters, c_cmd_parm_cat_session_object_iterate_forwards_handle ) );
         string context( get_parm_val( parameters, c_cmd_parm_cat_session_object_iterate_forwards_context ) );
         string key_info( get_parm_val( parameters, c_cmd_parm_cat_session_object_iterate_forwards_key_info ) );

         bool inclusive( has_parm_val( parameters, c_cmd_parm_cat_session_object_iterate_forwards_inc ) );
      ...
      else if( command == c_cmd_cat_session_object_iterate_backwards )
      {
         string handle( get_parm_val( parameters, c_cmd_parm_cat_session_object_iterate_backwards_handle ) );
         string context( get_parm_val( parameters, c_cmd_parm_cat_session_object_iterate_backwards_context ) );
         string key_info( get_parm_val( parameters, c_cmd_parm_cat_session_object_iterate_backwards_key_info ) );

         bool inclusive( has_parm_val( parameters, c_cmd_parm_cat_session_object_iterate_backwards_inc ) );
      ...
      else if( command == c_cmd_cat_session_object_iterate_next )
      {
         string handle( get_parm_val( parameters, c_cmd_parm_cat_session_object_iterate_next_handle ) );
         string context( get_parm_val( parameters, c_cmd_parm_cat_session_object_iterate_next_context ) );
      ...
      else if( command == c_cmd_cat_session_object_iterate_stop )
      {
         string handle( get_parm_val( parameters, c_cmd_parm_cat_session_object_iterate_stop_handle ) );
         string context( get_parm_val( parameters, c_cmd_parm_cat_session_object_iterate_stop_context ) );

         instance_iterate_stop( atoi( handle.c_str( ) ), context );
      }
      else if( command == c_cmd_cat_session_perform_fetch )
      {
         string module( get_parm_val( parameters, c_cmd_parm_cat_session_perform_fetch_module ) );
         string mclass( get_parm_val( parameters, c_cmd_parm_cat_session_perform_fetch_mclass ) );
         bool is_reverse( has_parm_val( parameters, c_cmd_parm_cat_session_perform_fetch_reverse ) );
         string uid( get_parm_val( parameters, c_cmd_parm_cat_session_perform_fetch_uid ) );
         string tz_abbr( get_parm_val( parameters, c_cmd_parm_cat_session_perform_fetch_tz_abbr ) );
         string filters( get_parm_val( parameters, c_cmd_parm_cat_session_perform_fetch_filters ) );
         string perms( get_parm_val( parameters, c_cmd_parm_cat_session_perform_fetch_perms ) );
         string security_info( get_parm_val( parameters, c_cmd_parm_cat_session_perform_fetch_security_info ) );
         string search_text( get_parm_val( parameters, c_cmd_parm_cat_session_perform_fetch_search_text ) );
         string search_query( get_parm_val( parameters, c_cmd_parm_cat_session_perform_fetch_search_query ) );
         string key_info( get_parm_val( parameters, c_cmd_parm_cat_session_perform_fetch_key_info ) );
         string limit( get_parm_val( parameters, c_cmd_parm_cat_session_perform_fetch_limit ) );
         string set_values( get_parm_val( parameters, c_cmd_parm_cat_session_perform_fetch_set_values ) );
         string fields( get_parm_val( parameters, c_cmd_parm_cat_session_perform_fetch_fields ) );
         bool minimal( has_parm_val( parameters, c_cmd_parm_cat_session_perform_fetch_minimal ) );
         bool create_pdf( has_parm_val( parameters, c_cmd_parm_cat_session_perform_fetch_create_pdf ) );
         string format_file( get_parm_val( parameters, c_cmd_parm_cat_session_perform_fetch_format_file ) );
         string output_file( get_parm_val( parameters, c_cmd_parm_cat_session_perform_fetch_output_file ) );
         string title_name( get_parm_val( parameters, c_cmd_parm_cat_session_perform_fetch_title_name ) );
      ...
      else if( command == c_cmd_cat_session_perform_create )
      {
         string next_command( socket_handler.get_next_command( ) );

         string uid( get_parm_val( parameters, c_cmd_parm_cat_session_perform_create_uid ) );
         string dtm( get_parm_val( parameters, c_cmd_parm_cat_session_perform_create_dtm ) );
         string module( get_parm_val( parameters, c_cmd_parm_cat_session_perform_create_module ) );
         string mclass( get_parm_val( parameters, c_cmd_parm_cat_session_perform_create_mclass ) );
         string tz_abbr( get_parm_val( parameters, c_cmd_parm_cat_session_perform_create_tz_abbr ) );
         string key( get_parm_val( parameters, c_cmd_parm_cat_session_perform_create_key ) );
         string field_values( get_parm_val( parameters, c_cmd_parm_cat_session_perform_create_field_values ) );
      ...
      else if( command == c_cmd_cat_session_perform_update )
      {
         string next_command( socket_handler.get_next_command( ) );

         string uid( get_parm_val( parameters, c_cmd_parm_cat_session_perform_update_uid ) );
         string dtm( get_parm_val( parameters, c_cmd_parm_cat_session_perform_update_dtm ) );
         string module( get_parm_val( parameters, c_cmd_parm_cat_session_perform_update_module ) );
         string mclass( get_parm_val( parameters, c_cmd_parm_cat_session_perform_update_mclass ) );
         string tz_abbr( get_parm_val( parameters, c_cmd_parm_cat_session_perform_update_tz_abbr ) );
         string key( get_parm_val( parameters, c_cmd_parm_cat_session_perform_update_key ) );
         string ver_info( get_parm_val( parameters, c_cmd_parm_cat_session_perform_update_ver_info ) );
         string field_values( get_parm_val( parameters, c_cmd_parm_cat_session_perform_update_field_values ) );
         string method_id_or_name( get_parm_val( parameters, c_cmd_parm_cat_session_perform_update_method_name ) );
         string check_values( get_parm_val( parameters, c_cmd_parm_cat_session_perform_update_check_values ) );
      ...
      else if( command == c_cmd_cat_session_perform_destroy )
      {
         string next_command( socket_handler.get_next_command( ) );

         string uid( get_parm_val( parameters, c_cmd_parm_cat_session_perform_destroy_uid ) );
         string dtm( get_parm_val( parameters, c_cmd_parm_cat_session_perform_destroy_dtm ) );
         string module( get_parm_val( parameters, c_cmd_parm_cat_session_perform_destroy_module ) );
         string mclass( get_parm_val( parameters, c_cmd_parm_cat_session_perform_destroy_mclass ) );
         string tz_abbr( get_parm_val( parameters, c_cmd_parm_cat_session_perform_destroy_tz_abbr ) );
         bool quiet( has_parm_val( parameters, c_cmd_parm_cat_session_perform_destroy_quiet ) );
         string key( get_parm_val( parameters, c_cmd_parm_cat_session_perform_destroy_key ) );
         string ver_info( get_parm_val( parameters, c_cmd_parm_cat_session_perform_destroy_ver_info ) );
      ...
      else if( command == c_cmd_cat_session_perform_execute )
      {
         string next_command( socket_handler.get_next_command( ) );

         string uid( get_parm_val( parameters, c_cmd_parm_cat_session_perform_execute_uid ) );
         string dtm( get_parm_val( parameters, c_cmd_parm_cat_session_perform_execute_dtm ) );
         string module( get_parm_val( parameters, c_cmd_parm_cat_session_perform_execute_module ) );
         string mclass( get_parm_val( parameters, c_cmd_parm_cat_session_perform_execute_mclass ) );
         string tz_abbr( get_parm_val( parameters, c_cmd_parm_cat_session_perform_execute_tz_abbr ) );
         string set_values( get_parm_val( parameters, c_cmd_parm_cat_session_perform_execute_set_values ) );
         string keys( get_parm_val( parameters, c_cmd_parm_cat_session_perform_execute_keys ) );
         string vers( get_parm_val( parameters, c_cmd_parm_cat_session_perform_execute_vers ) );
         string method_name_and_args( get_parm_val( parameters, c_cmd_parm_cat_session_perform_execute_method_name ) );
         ...
         if( !skip_execute )
         {
            ...
            if( has_parm_val( parameters, c_cmd_parm_cat_session_perform_execute_args ) )
            {
               string execute_args( get_parm_val( parameters, c_cmd_parm_cat_session_perform_execute_args ) );
      ...
      else if( command == c_cmd_cat_session_perform_bulk_ops )
      {
         string uid( get_parm_val( parameters, c_cmd_parm_cat_session_perform_bulk_ops_uid ) );
         string dtm( get_parm_val( parameters, c_cmd_parm_cat_session_perform_bulk_ops_dtm ) );
         string module( get_parm_val( parameters, c_cmd_parm_cat_session_perform_bulk_ops_module ) );
         string mclass( get_parm_val( parameters, c_cmd_parm_cat_session_perform_bulk_ops_mclass ) );
         string tz_abbr( get_parm_val( parameters, c_cmd_parm_cat_session_perform_bulk_ops_tz_abbr ) );
         string filename( get_parm_val( parameters, c_cmd_parm_cat_session_perform_bulk_ops_filename ) );
         string export_fields( get_parm_val( parameters, c_cmd_parm_cat_session_perform_bulk_ops_export_fields ) );
         bool destroy_records( has_parm_val( parameters, c_cmd_parm_cat_session_perform_bulk_ops_destroy_records ) );
         string search_text( get_parm_val( parameters, c_cmd_parm_cat_session_perform_bulk_ops_search_text ) );
         string search_query( get_parm_val( parameters, c_cmd_parm_cat_session_perform_bulk_ops_search_query ) );
         string fixed_field_values( get_parm_val( parameters, c_cmd_parm_cat_session_perform_bulk_ops_fixed_field_values ) );
      ...
      else if( command == c_cmd_cat_session_perform_package_export )
      {
         string module( get_parm_val( parameters, c_cmd_parm_cat_session_perform_package_export_module ) );
         string mclass( get_parm_val( parameters, c_cmd_parm_cat_session_perform_package_export_mclass ) );
         string keys( get_parm_val( parameters, c_cmd_parm_cat_session_perform_package_export_keys ) );
         string filename( get_parm_val( parameters, c_cmd_parm_cat_session_perform_package_export_filename ) );
         string test_info( get_parm_val( parameters, c_cmd_parm_cat_session_perform_package_export_test_info ) );
         string exclude_info( get_parm_val( parameters, c_cmd_parm_cat_session_perform_package_export_exclude_info ) );
         string include_info( get_parm_val( parameters, c_cmd_parm_cat_session_perform_package_export_include_info ) );

         export_package( module, mclass, keys, exclude_info, test_info, include_info, filename );
      }
      else if( command == c_cmd_cat_session_perform_package_import )
      {
         string uid( get_parm_val( parameters, c_cmd_parm_cat_session_perform_package_import_uid ) );
         string dtm( get_parm_val( parameters, c_cmd_parm_cat_session_perform_package_import_dtm ) );
         string module( get_parm_val( parameters, c_cmd_parm_cat_session_perform_package_import_module ) );
         string filename( get_parm_val( parameters, c_cmd_parm_cat_session_perform_package_import_filename ) );
         bool new_only( has_parm_val( parameters, c_cmd_parm_cat_session_perform_package_import_new_only ) );
         string key_prefix( get_parm_val( parameters, c_cmd_parm_cat_session_perform_package_import_key_prefix ) );
         string replace_info( get_parm_val( parameters, c_cmd_parm_cat_session_perform_package_import_replace_info ) );
         string skip_field_info( get_parm_val( parameters, c_cmd_parm_cat_session_perform_package_import_skip_field_info ) );
      ...
      else if( command == c_cmd_cat_session_session_list )
      {
         list_sessions( osstr );
         output_response_lines( socket, osstr.str( ) );
      }
      else if( command == c_cmd_cat_session_session_kill )
      {
         bool kill_all( has_parm_val( parameters, c_cmd_parm_cat_session_session_kill_all ) );
         string sess_ids( get_parm_val( parameters, c_cmd_parm_cat_session_session_kill_sess_ids ) );
         string seconds( get_parm_val( parameters, c_cmd_parm_cat_session_session_kill_seconds ) );
      ...
      else if( command == c_cmd_cat_session_session_lock )
      {
         bool lock_capture( has_parm_val( parameters, c_cmd_parm_cat_session_session_lock_capture ) );
         bool lock_release( has_parm_val( parameters, c_cmd_parm_cat_session_session_lock_release ) );
         bool lock_all( has_parm_val( parameters, c_cmd_parm_cat_session_session_lock_all ) );
         string sess_ids( get_parm_val( parameters, c_cmd_parm_cat_session_session_lock_sess_ids ) );
      ...
      else if( command == c_cmd_cat_session_session_timeout )
      {
         string seconds( get_parm_val( parameters, c_cmd_parm_cat_session_session_timeout_seconds ) );
      ...
      else if( command == c_cmd_cat_session_session_variable )
      {
         string var_name( get_parm_val( parameters, c_cmd_parm_cat_session_session_variable_var_name ) );
         bool has_new_val( has_parm_val( parameters, c_cmd_parm_cat_session_session_variable_new_value ) );
         string new_value( get_parm_val( parameters, c_cmd_parm_cat_session_session_variable_new_value ) );
      ...
      else if( command == c_cmd_cat_session_storage_info )
      {
         response = "Name: " + storage_name( ) + '\n';
         response += "Prefix: " + storage_module_prefix( ) + '\n';
         response += "Identity: " + storage_identity( );
      }
      else if( command == c_cmd_cat_session_storage_init )
      {
         string name( get_parm_val( parameters, c_cmd_parm_cat_session_storage_init_name ) );
         string prefix( get_parm_val( parameters, c_cmd_parm_cat_session_storage_init_prefix ) );

         init_storage( name, prefix, handler, has_parm_val( parameters, c_cmd_parm_cat_session_storage_init_admin ) );
      }
      else if( command == c_cmd_cat_session_storage_term )
         term_storage( handler );
      else if( command == c_cmd_cat_session_storage_create )
      {
         string name( get_parm_val( parameters, c_cmd_parm_cat_session_storage_create_name ) );
         string prefix( get_parm_val( parameters, c_cmd_parm_cat_session_storage_create_prefix ) );

         create_storage( name, prefix, handler, has_parm_val( parameters, c_cmd_parm_cat_session_storage_create_admin ) );
      }
      else if( command == c_cmd_cat_session_storage_attach )
      {
         string name( get_parm_val( parameters, c_cmd_parm_cat_session_storage_attach_name ) );

         attach_storage( name, handler, has_parm_val( parameters, c_cmd_parm_cat_session_storage_attach_admin ) );
      }
      else if( command == c_cmd_cat_session_storage_backup )
      {
         string name( get_parm_val( parameters, c_cmd_parm_cat_session_storage_backup_name ) );
         bool truncate_log( has_parm_val( parameters, c_cmd_parm_cat_session_storage_backup_truncate ) );
      ...
      else if( command == c_cmd_cat_session_storage_restore )
      {
         string name( get_parm_val( parameters, c_cmd_parm_cat_session_storage_restore_name ) );
         string prefix( get_parm_val( parameters, c_cmd_parm_cat_session_storage_restore_prefix ) );
         string trace_info( get_parm_val( parameters, c_cmd_parm_cat_session_storage_restore_trace_info ) );
         bool rebuild( has_parm_val( parameters, c_cmd_parm_cat_session_storage_restore_rebuild ) );
         bool partial( has_parm_val( parameters, c_cmd_parm_cat_session_storage_restore_partial ) );
         bool quicker( has_parm_val( parameters, c_cmd_parm_cat_session_storage_restore_quicker ) );
      ...
      else if( command == c_cmd_cat_session_storage_web_root )
      {
         bool expand( has_parm_val( parameters, c_cmd_parm_cat_session_storage_web_root_expand ) );

         string new_root( get_parm_val( parameters, c_cmd_parm_cat_session_storage_web_root_new_root ) );
      ...
      else if( command == c_cmd_cat_session_storage_log_slice )
      {
         string name( get_parm_val( parameters, c_cmd_parm_cat_session_storage_log_slice_name ) );
         string modules( get_parm_val( parameters, c_cmd_parm_cat_session_storage_log_slice_modules ) );
      ...
      else if( command == c_cmd_cat_session_storage_log_splice )
      {
         string name( get_parm_val( parameters, c_cmd_parm_cat_session_storage_log_splice_name ) );
         string modules( get_parm_val( parameters, c_cmd_parm_cat_session_storage_log_splice_modules ) );
      ...
      else if( command == c_cmd_cat_session_storage_dump_locks )
      {
         dump_storage_locks( osstr );
         output_response_lines( socket, osstr.str( ) );
      }
      else if( command == c_cmd_cat_session_storage_trans_start )
         transaction_start( );
      else if( command == c_cmd_cat_session_storage_trans_commit )
         transaction_commit( );
      else if( command == c_cmd_cat_session_storage_trans_rollback )
         transaction_rollback( );
      else if( command == c_cmd_cat_session_system_variable )
      {
         string var_name( get_parm_val( parameters, c_cmd_parm_cat_session_system_variable_var_name ) );
         bool has_new_val( has_parm_val( parameters, c_cmd_parm_cat_session_system_variable_new_value ) );
         string new_value( get_parm_val( parameters, c_cmd_parm_cat_session_system_variable_new_value ) );
      ...
      else if( command == c_cmd_cat_session_trace )
      {
         string flags( get_parm_val( parameters, c_cmd_parm_cat_session_trace_flags ) );
      ...
      else if( command == c_cmd_cat_session_trace_flags )
      {
      ...
      else if( command == c_cmd_cat_session_encrypt )
      {
         string password( get_parm_val( parameters, c_cmd_parm_cat_session_encrypt_password ) );

         response = encrypt_password( password );
      }
      else if( command == c_cmd_cat_session_sendmail )
      {
         string to( get_parm_val( parameters, c_cmd_parm_cat_session_sendmail_to ) );
         string subject( get_parm_val( parameters, c_cmd_parm_cat_session_sendmail_subject ) );
         string message( get_parm_val( parameters, c_cmd_parm_cat_session_sendmail_message ) );
         string tz_abbr( get_parm_val( parameters, c_cmd_parm_cat_session_sendmail_tz_abbr ) );
         string file_names( get_parm_val( parameters, c_cmd_parm_cat_session_sendmail_file_names ) );
         string html_source( get_parm_val( parameters, c_cmd_parm_cat_session_sendmail_html_source ) );
         string image_names( get_parm_val( parameters, c_cmd_parm_cat_session_sendmail_image_names ) );
         string image_prefix( get_parm_val( parameters, c_cmd_parm_cat_session_sendmail_image_prefix ) );
      ...
      else if( command == c_cmd_cat_session_schedule )
      {
         output_schedule( osstr );
         output_response_lines( socket, osstr.str( ) );
      }
      else if( command == c_cmd_cat_session_timezone )
         response = get_timezone( );
      else if( command == c_cmd_cat_session_checkmail )
      {
         string headers( get_parm_val( parameters, c_cmd_parm_cat_session_checkmail_headers ) );
         bool create_script( has_parm_val( parameters, c_cmd_parm_cat_session_checkmail_create_script ) );
      ...
      else if( command == c_cmd_cat_session_runscript )
      {
         string script_name( get_parm_val( parameters, c_cmd_parm_cat_session_runscript_script_name ) );

         run_script( script_name );
      }
      else if( command == c_cmd_cat_session_utc_offset )
      {
         string tz_abbr( get_parm_val( parameters, c_cmd_parm_cat_session_utc_offset_tz_abbr ) );
         string local_time( get_parm_val( parameters, c_cmd_parm_cat_session_utc_offset_local_time ) );
      ...
      else if( command == c_cmd_cat_session_wait )
      {
         string uid( get_parm_val( parameters, c_cmd_parm_cat_session_wait_uid ) );
         string milliseconds( get_parm_val( parameters, c_cmd_parm_cat_session_wait_milliseconds ) );

         set_uid( uid );
         msleep( atoi( milliseconds.c_str( ) ) );
      }
      else if( command == c_cmd_cat_session_test )
      {
         // Dummy command for prototyping.
      }
      else if( command == c_cmd_cat_session_quit )
      {
...
cat_session::cat_session( auto_ptr< tcp_socket >& ap_socket )
 :
 ap_socket( ap_socket )
{
   if( !( *this->ap_socket ) )
...
void cat_session::on_start( )
{
   ...
   try
   {
      ...
      cmd_handler.add_commands( 0,
       cat_session_command_functor_factory, ARRAY_PTR_AND_SIZE( cat_session_command_definitions ) );
...
void cat_session::increment_session_count( )
{
   guard g( g_mutex );
   ++g_active_sessions;
}

void cat_session::decrement_session_count( )
{
   guard g( g_mutex );
   --g_active_sessions;
}
