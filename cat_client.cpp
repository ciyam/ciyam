...
const char* const c_app_title = "cat_client";
...
const char* const c_default_cat_host = "localhost";
...
class cat_console_command_handler : public console_command_handler
{
   public:
   cat_console_command_handler( tcp_socket& socket )
    :
    port( c_default_cat_port ),
    host( c_default_cat_host ),
    socket( socket )
   {
...
string cat_console_command_handler::preprocess_command_and_args( const string& cmd_and_args )
{
...
void cat_console_command_handler::process_custom_startup_option( size_t num, const string& option )
{
   if( num == 0 )
   {
...
int main( int argc, char* argv[ ] )
{
   ...
   tcp_socket socket;
   cat_console_command_handler cmd_handler( socket );
