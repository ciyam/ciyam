...
void Meta_Modifier::impl::validate( unsigned state, bool is_internal, validation_error_container* p_validation_errors )
{
   ( void )state;
   ( void )is_internal;
...
void Meta_Modifier::impl::validate_set_fields( set< string >& fields_set, validation_error_container* p_validation_errors )
{
   ( void )fields_set;
...
void Meta_Modifier::impl::get_required_transients( set< string >& names ) const
{
...
void Meta_Modifier::validate( unsigned state, bool is_internal )
{
...
void Meta_Modifier::finalise_fetch( )
{
...
bool Meta_Modifier::is_file_field_name( const string& name ) const
{
...
string Meta_Modifier::get_field_display_name( const string& id_or_name ) const
{
   ...
   else if( id_or_name == c_field_id_Source_Modifier || id_or_name == c_field_name_Source_Modifier )
...
void Meta_Modifier::do_generate_sql( generate_sql_type type, vector< string >& sql_stmts ) const
{
...
string Meta_Modifier::static_get_sql_columns( )
{
   ...
   sql_columns += 
    ...
    "C_Source_Modifier VARCHAR(64) NOT NULL,"
    "PRIMARY KEY(C_Key_)";
