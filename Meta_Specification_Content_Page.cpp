...
void Meta_Specification_Content_Page::impl::validate_set_fields( set< string >& fields_set, validation_error_container* p_validation_errors )
{
   ( void )fields_set;
...
void Meta_Specification_Content_Page::validate_set_fields( set< string >& fields_set )
{
