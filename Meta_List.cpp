...
bool Meta_List::impl::is_filtered( const set< string >& filters ) const
{
   ( void )filters;
...
bool Meta_List::is_filtered( const set< string >& filters ) const
{
...
string Meta_List::get_field_display_name( const string& id ) const
{
   string display_name;
