...
void Meta_List_command_functor::operator ( )( const string& command, const parameter_info& parameters )
{
   ...
   else if( command == c_cmd_Meta_List_get )
   {
      ...
      else if( field_name == c_field_id_Create_Only_If_Default_Other || field_name == c_field_name_Create_Only_If_Default_Other )
      ...
      else if( field_name == c_field_id_Create_Restriction || field_name == c_field_name_Create_Restriction )
         string_getter< int >( cmd_handler.p_Meta_List->Create_Restriction( ), cmd_handler.retval );
      else if( field_name == c_field_id_Destroy_Only_If_Default_Other || field_name == c_field_name_Destroy_Only_If_Default_Other )
      ...
      else if( field_name == c_field_id_Destroy_Restriction || field_name == c_field_name_Destroy_Restriction )
         string_getter< int >( cmd_handler.p_Meta_List->Destroy_Restriction( ), cmd_handler.retval );
      else if( field_name == c_field_id_Direction || field_name == c_field_name_Direction )
         string_getter< int >( cmd_handler.p_Meta_List->Direction( ), cmd_handler.retval );
      else if( field_name == c_field_id_Display_Only_If_Default_Other || field_name == c_field_name_Display_Only_If_Default_Other )
         string_getter< bool >( cmd_handler.p_Meta_List->Display_Only_If_Default_Other( ), cmd_handler.retval );
      else if( field_name == c_field_id_Display_Row_Limit || field_name == c_field_name_Display_Row_Limit )
         string_getter< int >( cmd_handler.p_Meta_List->Display_Row_Limit( ), cmd_handler.retval );
      else if( field_name == c_field_id_Display_Security_Level || field_name == c_field_name_Display_Security_Level )
      ...
      else if( field_name == c_field_id_Ignore_User_Id_Filter || field_name == c_field_name_Ignore_User_Id_Filter )
      ...
      else if( field_name == c_field_id_Multiline_Truncate_For_Print || field_name == c_field_name_Multiline_Truncate_For_Print )
      ...
      else if( field_name == c_field_id_Print_Restriction || field_name == c_field_name_Print_Restriction )
         string_getter< int >( cmd_handler.p_Meta_List->Print_Restriction( ), cmd_handler.retval );
      else if( field_name == c_field_id_Print_Without_Highlight || field_name == c_field_name_Print_Without_Highlight )
      ...
      else if( field_name == c_field_id_Sort_Rows_In_UI || field_name == c_field_name_Sort_Rows_In_UI )
         string_getter< bool >( cmd_handler.p_Meta_List->Sort_Rows_In_UI( ), cmd_handler.retval );
      else if( field_name == c_field_id_Style || field_name == c_field_name_Style )
         string_getter< int >( cmd_handler.p_Meta_List->Style( ), cmd_handler.retval );
      else if( field_name == c_field_id_Text_Match_Highlight || field_name == c_field_name_Text_Match_Highlight )
         string_getter< int >( cmd_handler.p_Meta_List->Text_Match_Highlight( ), cmd_handler.retval );
      else if( field_name == c_field_id_Title || field_name == c_field_name_Title )
      ...
      else if( field_name == c_field_id_Variation_Name || field_name == c_field_name_Variation_Name )
...
void Meta_List::impl::validate( unsigned state, bool is_internal, validation_error_container* p_validation_errors )
{
   ...
   if( !g_list_direction_enum.count( v_Direction ) )
      p_validation_errors->insert( validation_error_value_type( c_field_name_Direction,
       get_string_message( GS( c_str_field_has_invalid_value ), make_pair(
   ...
   if( !g_list_display_row_limit_enum.count( v_Display_Row_Limit ) )
      p_validation_errors->insert( validation_error_value_type( c_field_name_Display_Row_Limit,
       get_string_message( GS( c_str_field_has_invalid_value ), make_pair(
   ...
   if( !g_pdf_font_type_enum.count( v_PDF_Font_Type ) )
      p_validation_errors->insert( validation_error_value_type( c_field_name_PDF_Font_Type,
       get_string_message( GS( c_str_field_has_invalid_value ), make_pair(
   ...
   if( !g_list_pdf_list_type_enum.count( v_PDF_List_Type ) )
      p_validation_errors->insert( validation_error_value_type( c_field_name_PDF_List_Type,
       get_string_message( GS( c_str_field_has_invalid_value ), make_pair(
   ...
   if( !g_list_print_restrict_enum.count( v_Print_Restriction ) )
      p_validation_errors->insert( validation_error_value_type( c_field_name_Print_Restriction,
       get_string_message( GS( c_str_field_has_invalid_value ), make_pair(
   ...
   if( !g_list_style_enum.count( v_Style ) )
      p_validation_errors->insert( validation_error_value_type( c_field_name_Style,
       get_string_message( GS( c_str_field_has_invalid_value ), make_pair(
   ...
   if( !g_list_text_match_highlight_enum.count( v_Text_Match_Highlight ) )
      p_validation_errors->insert( validation_error_value_type( c_field_name_Text_Match_Highlight,
       get_string_message( GS( c_str_field_has_invalid_value ), make_pair(
...
string Meta_List::get_field_display_name( const string& id_or_name ) const
{
   ...
   else if( id_or_name == c_field_id_Create_Only_If_Default_Other || id_or_name == c_field_name_Create_Only_If_Default_Other )
   ...
   else if( id_or_name == c_field_id_Destroy_Only_If_Default_Other || id_or_name == c_field_name_Destroy_Only_If_Default_Other )
   ...
   else if( id_or_name == c_field_id_Direction || id_or_name == c_field_name_Direction )
      display_name = get_module_string( c_field_display_name_Direction );
   else if( id_or_name == c_field_id_Display_Only_If_Default_Other || id_or_name == c_field_name_Display_Only_If_Default_Other )
      display_name = get_module_string( c_field_display_name_Display_Only_If_Default_Other );
   else if( id_or_name == c_field_id_Display_Row_Limit || id_or_name == c_field_name_Display_Row_Limit )
      display_name = get_module_string( c_field_display_name_Display_Row_Limit );
   else if( id_or_name == c_field_id_Display_Security_Level || id_or_name == c_field_name_Display_Security_Level )
   ...
   else if( id_or_name == c_field_id_Multiline_Truncate_For_Print || id_or_name == c_field_name_Multiline_Truncate_For_Print )
   ...
   else if( id_or_name == c_field_id_Number_Multiple_Pages || id_or_name == c_field_name_Number_Multiple_Pages )
   ...
   else if( id_or_name == c_field_id_PDF_List_Type || id_or_name == c_field_name_PDF_List_Type )
   ...
   else if( id_or_name == c_field_id_Parent_Field || id_or_name == c_field_name_Parent_Field )
      display_name = get_module_string( c_field_display_name_Parent_Field );
   else if( id_or_name == c_field_id_Print_Restriction || id_or_name == c_field_name_Print_Restriction )
   ...
   else if( id_or_name == c_field_id_Search_Option_Limit || id_or_name == c_field_name_Search_Option_Limit )
      display_name = get_module_string( c_field_display_name_Search_Option_Limit );
   else if( id_or_name == c_field_id_Sort_Rows_In_UI || id_or_name == c_field_name_Sort_Rows_In_UI )
      display_name = get_module_string( c_field_display_name_Sort_Rows_In_UI );
   else if( id_or_name == c_field_id_Style || id_or_name == c_field_name_Style )
      display_name = get_module_string( c_field_display_name_Style );
   else if( id_or_name == c_field_id_Text_Match_Highlight || id_or_name == c_field_name_Text_Match_Highlight )
   ...
   else if( id_or_name == c_field_id_Variation_Name || id_or_name == c_field_name_Variation_Name )
 ...
 set< string >& names, bool required_transients, set< string >* p_dependents ) const
{
   ...
   if( needs_field_value( "Name", dependents ) )
   {
      ...
      if( ( required_transients && is_field_transient( e_field_id_Variation_Name ) )
       || ( !required_transients && !is_field_transient( e_field_id_Variation_Name ) ) )
 ...
 set< string >& names, bool required_transients, set< string >& dependents ) const
{
   ...
   if( ( required_transients && is_field_transient( e_field_id_PDF_List_Type ) )
    || ( !required_transients && !is_field_transient( e_field_id_PDF_List_Type ) ) )
   ...
   if( ( required_transients && is_field_transient( e_field_id_Is_Child ) )
    || ( !required_transients && !is_field_transient( e_field_id_Is_Child ) ) )
   ...
   if( ( required_transients && is_field_transient( e_field_id_Allow_Text_Search ) )
    || ( !required_transients && !is_field_transient( e_field_id_Allow_Text_Search ) ) )
   ...
   if( ( required_transients && is_field_transient( e_field_id_Style ) )
    || ( !required_transients && !is_field_transient( e_field_id_Style ) ) )
      names.insert( "Style" );
   // [(finish modifier_field_value)]
   ...
   if( ( required_transients && is_field_transient( e_field_id_Is_Home ) )
    || ( !required_transients && !is_field_transient( e_field_id_Is_Home ) ) )
   ...
   if( ( required_transients && is_field_transient( e_field_id_Display_Row_Limit ) )
    || ( !required_transients && !is_field_transient( e_field_id_Display_Row_Limit ) ) )
   ...
   if( ( required_transients && is_field_transient( e_field_id_Sort_Rows_In_UI ) )
    || ( !required_transients && !is_field_transient( e_field_id_Sort_Rows_In_UI ) ) )
...
void Meta_List::do_generate_sql( generate_sql_type type, vector< string >& sql_stmts ) const
{
...
string Meta_List::static_get_sql_columns( )
{
   ...
   sql_columns += 
    ...
    "C_Parent_Field VARCHAR(64) NOT NULL,"
