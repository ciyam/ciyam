...
void Meta_Procedure_Arg::impl::do_post_init( )
{
   // [<start do_post_init>]
   // [<finish do_post_init>]
}
...
void Meta_Procedure_Arg::do_post_init( )
{
   p_impl->do_post_init( );
}
...
bool Meta_Procedure_Arg::is_file_field_name( const string& name ) const
{
...
void Meta_Procedure_Arg::do_generate_sql(
