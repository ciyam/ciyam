...
//	var iframe = '<table cellpadding="0" cellspacing="0" border="0" style="width:' + wysiwygWidth + 'px; height:' + wysiwygHeight + 'px;border: 1px inset #CCCCCC;"><tr><td valign="top">\n'
	var iframe = '<table cellpadding="0" cellspacing="0" border="0" style="width:' + wysiwygWidth + 'px; height:' + wysiwygHeight + 'px;border: 0px inset #CCCCCC;"><tr><td valign="top">\n'
//  + '<iframe frameborder="0" id="wysiwyg' + n + '"></iframe>\n'
  + '<iframe frameborder="0" id="wysiwyg' + n + '" name="wysiwyg' + n + '" style="background-color: #FFFFFF"></iframe>\n'
  + '</td></tr></table>\n';
